...
(function () {
  ...
  const haHeroImg = "/v2/assets/4f1eb788-ca3b-46e2-9876-8d0dde3d0bad.png";
        ...
        <div className="col-start-3 col-span-8 content-stretch flex flex-col gap-[22.8px] items-start justify-self-stretch pb-[24px] pt-[160px] relative row-1 self-center shrink-0">
          ...
          <div className="content-stretch flex flex-col items-start max-w-[524.88px] pb-[0.785px] relative shrink-0 w-[524.88px]">
            <div className="text-[16.5px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400, lineHeight: '23.94px' }}>
              <p className="m-0 text-white">Clain handles even the most complex queries through a continuous</p>
              <p className="m-0">
                <span className="text-white">improvement loop called the Clain Flywheel.</span>
                <span style={{ color: 'rgba(255,255,255,0.6)' }}>{` Train Clain on your`}</span>
              </p>
          ...
          <div className="content-start flex flex-wrap gap-[12px] items-start pt-[9.2px] relative shrink-0 w-full">
            <button onClick={() => ClainV2.navigate('/signup')} className="bg-white border-0 cursor-pointer flex h-[42px] items-center justify-center px-[16px] py-[13px] rounded-[6px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400, fontSize: 14.4, lineHeight: '16px', letterSpacing: '-0.32px', color: '#000' }}>Start free trial</button>
            <button onClick={() => ClainV2.navigate('/demo')} className="bg-transparent cursor-pointer flex h-[42px] items-center justify-center px-[17px] py-[13px] rounded-[6px] text-white" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400, fontSize: 14.8, lineHeight: '16px', letterSpacing: '-0.32px', border: '1px solid white' }}>View demo</button>
          </div>
          <div className="content-stretch flex gap-[24px] items-start pt-[25.2px] relative shrink-0 w-full">
            ...
            <div className="content-stretch flex flex-col gap-[15.5px] items-start max-w-[280px] min-w-[280px] relative self-stretch shrink-0">
              ...
              <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                <button onClick={() => ClainV2.navigate('/cx-models')} className="cursor-pointer flex items-center justify-center pb-[4px] bg-transparent text-white border-0" style={{ borderBottom: '1px solid white', opacity: 0.8 }}>
  ...
  const haTrainImg          = "/v2/assets/33429652-b2ff-4869-a0ae-33484afe98ac.png";
  const haTrainConnectors   = "/v2/assets/23fcd966-069c-4698-85d9-78f608c76c3a.png";
  const haTrainKnowledge    = "/v2/assets/0e1ea670-6bc7-4f3c-a0fc-6f1a86d99460.png";
  const haTrainGuidance     = "/v2/assets/1869bc20-47d2-4072-b00c-1e9c673978c4.png";
      ...
      <section id="train" className="bg-[#080f1e] content-stretch flex flex-col gap-[32px] items-start pb-[48px] pt-[32px] px-[48px] relative w-full" data-node-id="32:15466">
        ...
        <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full">
          <div className="grid grid-cols-10 gap-x-[16px] gap-y-[24px] pb-[32px] relative shrink-0 w-full">
            <div className="col-span-5">
              <p className="m-0 text-[54px] text-white tracking-[-3.008px] leading-[54px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300 }}>
                <span style={{ display: 'block' }}>Train Clain to resolve the</span>
              ...
              <div className="content-stretch flex flex-col gap-[24px] items-start max-w-[420px] pt-[9.6px] relative shrink-0 w-full">
                <div className="relative w-full flex items-start gap-[40px]">
                  ...
                  <p className="m-0 text-[16.5px] text-[#cecfd2] leading-[23.94px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
                    <span style={{ display: 'block' }}>Train Clain on your Procedures, knowledge, and</span>
                ...
                <div className="content-start flex flex-wrap items-start relative shrink-0 w-full">
                  <a onClick={() => ClainV2.navigate('#')} className="border border-solid border-white content-stretch cursor-pointer flex h-[42px] items-center justify-center pb-[13.5px] pt-[12.5px] px-[17px] relative rounded-[6px] shrink-0">
          ...
          <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
            ...
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[466.55px] max-w-full">
              ...
              <p className="m-0 text-[12.7px] text-[#cecfd2] tracking-[0.496px] leading-[18px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
                <span style={{ display: 'block' }}>Procedures let Clain handle complex queries with multiple steps,</span>
          ...
          <div className="grid grid-cols-3 gap-x-[16px] gap-y-[40px] relative shrink-0 w-full">
            {[
              { img: haTrainConnectors, title: 'Data Connectors',   body: ['Data Connectors enable Clain to securely retrieve', 'data and take action in external systems like', 'Shopify, Stripe, and Salesforce.'] },
              { img: haTrainKnowledge,  title: 'Knowledge Sources', body: ['Clain instantly learns from a variety of public and', 'private knowledge sources, including Help Center', 'articles, internal support content, PDFs, and URLs.'] },
  ...
  const haTestImg          = "/v2/assets/062dff02-1a24-4276-a69d-659e702a3b08.png";
  const haTestSimLibrary   = "/v2/assets/234ae064-40c4-45fd-ace6-40db0224dc98.png";
  const haTestPreviews     = "/v2/assets/26ad416d-0dbd-4780-9c2d-6015e0168f4e.png";
  const haTestAudience     = "/v2/assets/d17982d1-9849-4937-b753-1ef925b646a8.png";
                  ...
                  <div className="flex items-start gap-[40px]">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="m-0 text-[16.5px] text-[#cecfd2] leading-[23.94px] pt-[12px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
                        <span style={{ display: 'block' }}>from start to finish to see exactly how Clain will behave</span>
          ...
          <div className="content-stretch flex flex-col gap-[64px] items-start relative shrink-0 w-full">
            ...
            <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
              ...
              <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[466.55px] max-w-full">
                ...
                <p className="m-0 text-[12.7px] text-[#cecfd2] tracking-[0.496px] leading-[18px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
                  ...
                  <span style={{ display: 'block' }}>how Clain will respond. You can see what Clain is doing, when it is</span>
            ...
            <div className="grid grid-cols-3 gap-x-[16px] gap-y-[40px] relative shrink-0 w-full">
              {[
                ...
                { img: haTestPreviews,   title: 'Previews',           body: ['Preview changes in real time to see how Clain will', 'respond, and refine answers until you’re ready to go', 'live.'] },
                { img: haTestAudience,   title: 'Audience testing',   body: ['Test how Clain answers for various customer types', 'across multiple brands by simulating different', 'audiences or personas.'] },
              ].map((card) => (
                <div key={card.title} className="content-stretch flex flex-col gap-[15px] items-start relative shrink-0">
                  <div className="bg-[#151b29] border border-solid border-[#393f4b] content-stretch flex flex-col items-start justify-center p-px relative shrink-0 w-full">
                    <div className="aspect-square relative shrink-0 w-full overflow-clip">
  ...
  const haDepHeroBg     = "/v2/assets/7ae51545-2122-4ef0-bcd0-cc678611671d.png";
  const haDepPhone      = "/v2/assets/175e80bd-df74-4cc6-8704-25a9a137bd9a.png";
  const haDepEmail      = "/v2/assets/28eb15c6-f4fb-4b69-8ddd-296fa9e72ac1.png";
  const haDepLiveChat   = "/v2/assets/0896857c-0809-4a3e-b359-a008928fdcd2.png";
  const haDepWhatsApp   = "/v2/assets/bee1a032-c670-41b4-83a5-3070c72887fd.png";
  const haDepSlack      = "/v2/assets/5a72d9f9-3670-44f4-b0d5-9a24d621dea5.png";
  const haDepApi        = "/v2/assets/faa668ad-08ff-478b-ba7d-c1bc7bd6beb7.png";
  const haDepSocial     = "/v2/assets/a1c52c63-7006-4c82-ae59-167e1f248ab1.png";

  const HA_DEPLOY_CHANNELS = [
    { img: haDepEmail,    title: 'Email',     body: ['Clain replies instantly from your domain, in your brand', 'voice, with clarity and accuracy—making email as', 'fast and reliable as any other support channel.'], badge: null },
    { img: haDepLiveChat, title: 'Live chat', body: ["Whether it's on your existing live chat tool, or the", 'industry-leading Clain Messenger—Clain delivers', 'the best conversational support experience to your', 'customers.'], badge: null },
    { img: haDepWhatsApp, title: 'WhatsApp',  body: ['Clain delivers conversational support across', 'WhatsApp, SMS and Discord, to keep the customer', 'experience consistent across all your channels.'], badge: 'New' },
    { img: haDepSlack,    title: 'Slack',     body: ['Clain supports your customers directly in Slack', 'communities and Connect channels. Replies are', 'instant, stay threaded, and feel native to Slack.'], badge: null },
    { img: haDepApi,      title: 'API',       body: ['Use Clain’s API to embed Clain into your custom app—', 'delivering fast, accurate support wherever your', 'customers need it, without changing your existing', 'systems.'], badge: null },
    { img: haDepSocial,   title: 'Social',    body: ['Clain can deliver conversational support experiences', 'consistently on your social channels too, including', 'Facebook and Instagram.'], badge: null },
  ];
          ...
          <div className="grid grid-cols-10 gap-x-[16px] gap-y-[24px] pb-[32px] relative shrink-0 w-full">
            <div className="col-span-5">
              <p className="m-0 text-[53.6px] text-white tracking-[-3.008px] leading-[54px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300 }}>
                <span style={{ display: 'block' }}>Deploy Clain across</span>
            ...
            <div className="col-span-5 pl-[52.125px] max-w-[472.125px]">
              <div className="content-stretch flex flex-col gap-[24px] items-start max-w-[420px] pt-[9.6px] relative shrink-0 w-full">
                <div className="relative w-full flex items-start gap-[40px]">
                  ...
                  <p className="m-0 text-[16.5px] text-[#cecfd2] leading-[23.94px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
                    <span style={{ display: 'block' }}>Deploy Clain across phone, email, chat, Slack,</span>
          ...
          <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
            ...
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[466.55px] max-w-full">
              ...
              <p className="m-0 text-[12.8px] text-[#cecfd2] tracking-[0.496px] leading-[18px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
                <span style={{ display: 'block' }}>Clain Voice is a radically better experience for every caller. It delivers</span>
                <span style={{ display: 'block' }}>instant, natural conversations that feel human and never lose context.</span>
                <span style={{ display: 'block' }}>Clain Voice is simple to set up, easy to preview, and works with all major</span>
  ...
  const haAnaTopics    = "/v2/assets/8b97a52f-9463-4ff5-83ca-0359449f35b2.png";
  const haAnaCx        = "/v2/assets/b7456845-7c26-4f59-96d1-9d436b7b183e.png";
  const haAnaSugg      = "/v2/assets/1b90bb8c-30c7-4230-a2f8-82e26cdeb61a.png";
  const haAnaOptimize  = "/v2/assets/60cd94aa-4ded-4b4d-af4d-dfb239e88065.png";
      ...
      <section id="analyze" className="bg-[#080f1e] content-stretch flex flex-col gap-[32px] items-start pb-[48px] pt-[32px] px-[48px] relative w-full" data-node-id="32:15780">
        ...
        <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full">
          <div className="grid grid-cols-10 gap-x-[16px] gap-y-[24px] pb-[32px] relative shrink-0 w-full">
            <div className="col-span-5">
              <p className="m-0 text-[53.6px] text-white tracking-[-3.008px] leading-[54px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300 }}>
                <span style={{ display: 'block' }}>Analyze Clain with AI-</span>
                ...
                <div className="relative w-full flex items-start gap-[40px]">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="m-0 text-[16.3px] text-[#cecfd2] leading-[23.94px] pt-[12px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
                      ...
                      <span style={{ display: 'block' }}>those Insights to retrain Clain and continuously improve</span>
                      <span style={{ display: 'block' }}>your customer experience.</span>
                    </p>
                  </div>
                </div>
                <div className="content-start flex flex-wrap items-start relative shrink-0 w-full">
          ...
          <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
            ...
            <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[466.55px] max-w-full">
              ...
              <p className="m-0 text-[12.7px] text-[#cecfd2] tracking-[0.496px] leading-[18px]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
                ...
                <span style={{ display: 'block' }}>impact customer experience.</span>
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-x-[16px] gap-y-[40px] relative shrink-0 w-full">
            {[
              ...
              { img: haAnaSugg,     title: 'AI Suggestions',     body: ['Clain generates content updates to improve answers.', 'Accept with one click, and Clain will immediately use', 'that content to deliver better responses.'] },
              { img: haAnaOptimize, title: 'Optimize Dashboard', body: ['The Optimize Dashboard highlights opportunities to', 'improve Clain’s performance with AI-powered', 'Suggestions. Accept with one click for instant', 'optimization.'] },
            ].map((card) => (
              <div key={card.title} className="content-stretch flex flex-col gap-[15px] items-start relative shrink-0">
                <div className="bg-[#151b29] border border-solid border-[#393f4b] content-stretch flex flex-col items-start justify-center p-px relative shrink-0 w-full">
                  <div className="aspect-square relative shrink-0 w-full overflow-clip">
  ...
  const HA_FAQS = [
    { q: 'What types of work can Clain handle?', a: 'Clain handles complex, multi-step support queries across every channel — from simple FAQs to deeply contextual conversations involving Procedures, knowledge sources, and external systems like Shopify, Stripe, and Salesforce.' },
    { q: 'How does Clain keep responses accurate and on-brand?', a: 'Clain uses Guidance to enforce your brand voice, vocabulary, and policies on every response. Combined with Procedures and curated Knowledge Sources, Clain stays accurate, consistent, and on-brand across every customer interaction.' },
    { q: 'Does Clain support multilingual workflows?', a: 'Yes — Clain detects the customer\'s language and responds natively in 45+ languages, while applying the same Procedures, Guidance, and Knowledge Sources you have set up.' },
  ];
  ...
  const haCtaBgFlare = "/v2/assets/d24b3b8a-871b-4ea5-9c92-acc7253b7a00.png";
