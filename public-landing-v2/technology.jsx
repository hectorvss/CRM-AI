...
(function () {
  ...
  const imgImage = "/v2/assets/586cee155109d31eb02dd13491c7a97c8bacd68f.png";
  ...
  const imgAHeadshotOfAngeloLivanosSeniorDirectorAtLightspeed = "/v2/assets/7b8cf3262869cf788e89d1b9dd21af82e173dabe.png";
  const imgVideoThumbnail = "/v2/assets/caf5d6e800a45c010cbd4f0cc75e82e57a213207.png";
  const imgAiAtEnterpriseScaleWhyLightspeedChoseFin = "/v2/assets/6350c7074865dd31330c6c3af04ebff050c9d860.png";
  const imgHowRocketMoneyOperationalizedAi = "/v2/assets/04452f9eeca30e25a2671f79fe43a2bb0f51bd30.png";
    ...
    return (
      ...
      <div className="absolute content-stretch flex flex-col inset-0 items-center" data-node-id="2:18928" data-name="div.pointer-events-none">
        <div className="flex-[1_0_0] max-w-[1536px] min-h-px overflow-clip relative w-[1440px]" data-node-id="2:18929" data-name="div.absolute">
          <div className="absolute content-stretch flex flex-col h-[1099.98px] items-start left-[-187.2px] opacity-[var(--item-spacing\/0,0)] right-[-187.2px] top-[-113.49px]" data-node-id="2:18931" data-name="div.absolute">
          ...
          <div className="absolute bg-gradient-to-r bottom-0 from-[var(--color\/azure\/5,#020917)] left-0 to-[var(--color\/azure\/5-0\%,rgba(2,9,23,0))] top-0 w-[230px]" data-node-id="2:18935" data-name="div.z-1" />
          <div className="absolute bg-gradient-to-l bottom-0 from-[var(--color\/azure\/5,#020917)] right-0 to-[var(--color\/azure\/5-0\%,rgba(2,9,23,0))] top-0 w-[230px]" data-node-id="2:18937" data-name="div.z-1" />
          <div className="absolute bg-gradient-to-t bottom-0 from-[var(--color\/azure\/5,#020917)] h-[240px] left-0 right-0 to-[var(--color\/azure\/5-0\%,rgba(2,9,23,0))] via-1/4 via-[var(--color\/azure\/5-85\%,rgba(2,9,23,0.85))]" data-node-id="2:18938" data-name="div.z-1" />
          <div className="absolute bg-gradient-to-b from-[var(--color\/azure\/5,#020917)] h-[180px] left-0 right-0 to-[var(--color\/azure\/5-0\%,rgba(2,9,23,0))] top-0 via-1/2 via-[var(--color\/azure\/5-60\%,rgba(2,9,23,0.6))]" data-node-id="2:18940" data-name="div.z-1" />
        </div>
      </div>
          ...
          <div className="content-stretch flex flex-col items-start pb-[24px] px-[169.875px] relative shrink-0 w-full" data-node-id="2:18946" data-name="h1.enable-ligatures:margin">
            <div className="h-[192px] relative shrink-0 w-full" data-node-id="2:18947" data-name="h1.enable-ligatures">
              ...
              <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Light',sans-serif)] font-[var(--font-weight\/300,300)] h-[96px] justify-center leading-[0] left-[calc(50%+48.33px)] not-italic text-[95.4px] text-[color:var(--color\/white\/solid,white)] text-center top-[143.5px] tracking-[var(--letter-spacing\/-3_01,-3.008px)] w-[955.95px]" data-node-id="2:18956">
                <p className="leading-[var(--line-height\/96,96px)]">{` your customer service`}</p>
              </div>
            </div>
          </div>
              ...
              <div className="content-stretch flex flex-col gap-[var(--item-spacing\/15_5,15.5px)] items-start max-w-[280px] min-w-[280px] relative self-stretch shrink-0 w-[280px]" data-node-id="2:18993" data-name="div.flex">
                ...
                <div className="content-stretch flex flex-col items-start opacity-[var(--opacity\/80,0.8)] relative shrink-0 w-full" data-node-id="2:18999" data-name="span.text-current">
                  <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[10.5px] text-[color:var(--color\/white\/solid,white)] tracking-[var(--letter-spacing\/1_5,1.504px)] uppercase whitespace-nowrap" data-node-id="2:19000">
                    <p className="leading-[var(--line-height\/14,14px)] mb-0">Clain combines an autonomous.</p>
          ...
          <div className="col-[1/span_4] content-stretch flex flex-col gap-[var(--line-height\/24,24px)] items-start justify-self-stretch max-w-[420px] relative row-2 self-start shrink-0" data-node-id="2:19032" data-name="div.col-span-12">
            <div className="font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] h-[167.56px] leading-[0] not-italic relative shrink-0 w-full" data-node-id="2:19034" data-name="p.font-sans">
              ...
              <div className="-translate-y-1/2 absolute flex flex-col h-[144px] justify-center left-0 text-[16.5px] text-[color:var(--color\/grey\/19,#313130)] top-[94.78px] w-[392.79px]" data-node-id="2:19045">
                ...
                <p className="leading-[var(--line-height\/23_94,23.94px)] mb-0">Plug Clain into your stack with 30+ native integrations.</p>
                ...
                <div className="absolute content-stretch flex flex-col items-start left-0 pt-[8px] right-0 top-[35.94px]" data-node-id="2:19113" data-name="span.font-sans:margin">
                  <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-node-id="2:19114" data-name="span.font-sans">
                    <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[12.7px] text-[color:var(--color\/grey\/38,#626260)] tracking-[var(--stroke-weight\/0_5,0.499px)] w-full" data-node-id="2:19115">
                      ...
                      <p className="leading-[var(--font-size\/18,18px)] mb-0">Pairs Clain AI with humans for.</p>
                  ...
                  <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[var(--item-spacing\/20_01,20.01px)] items-start relative size-full">
                    <div className="h-[223.34px] relative shrink-0 w-full" data-node-id="2:19499" data-name="p.text-current">
                      <div className="-translate-y-1/2 absolute flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Light',sans-serif)] font-[var(--font-weight\/300,300)] h-[128px] justify-center leading-[0] left-0 not-italic text-[21.9px] text-[color:var(--color\/black\/solid,black)] top-[63.36px] w-[252.06px]" data-node-id="2:19500">
                        ...
                        <p className="leading-[var(--line-height\/31_92,31.92px)] mb-0">Modern helpdesk, rebuilt</p>
                        ...
                        <div className="absolute content-stretch flex flex-col gap-[var(--item-spacing\/-1,0px)] items-start justify-between left-0 pb-[33px] pt-[32px] px-[32px] top-0 w-[1058.66px]" data-node-id="2:19530" data-name="div.absolute">
                          ...
                          <div className="content-stretch flex flex-col items-start mb-[-1px] pr-[44.77px] relative shrink-0" data-node-id="2:19544" data-name="p.text-current">
                            <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Light',sans-serif)] font-[var(--font-weight\/300,300)] justify-center leading-[0] not-italic relative shrink-0 text-[29.1px] text-[color:var(--color\/white\/solid,white)] tracking-[var(--letter-spacing\/-0_4,-0.4px)] whitespace-nowrap" data-node-id="2:19545">
                              <p className="leading-[var(--line-height\/35,35px)] mb-0">Clain pulls customer context from.</p>
        ...
        <div className="absolute content-stretch flex flex-col gap-[var(--line-height\/24,24px)] items-start left-0 top-0 w-[417px]" data-node-id="2:19632" data-name="hgroup.col-span-10">
          ...
          <div className="font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] h-[71.81px] leading-[0] not-italic relative shrink-0 w-full" data-node-id="2:19637" data-name="p.font-sans">
            ...
            <div className="-translate-y-1/2 absolute flex flex-col h-[24px] justify-center left-[52.86px] text-[16.3px] text-[color:var(--color\/white\/solid,white)] top-[11px] w-[337.14px]" data-node-id="2:19641">
              <p className="leading-[var(--line-height\/23_94,23.94px)]">The first helpdesk where AI resolution is.</p>
            </div>
            <div className="-translate-y-1/2 absolute flex flex-col h-[48px] justify-center left-0 text-[16.3px] text-[color:var(--color\/white\/solid,white)] top-[46.91px] w-[418.89px]" data-node-id="2:19643">
              ...
              <p className="leading-[var(--line-height\/23_94,23.94px)]">Clain combines an autonomous AI agent with a modern inbox.</p>
            </div>
          </div>
        </div>
                ...
                <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[var(--font-size\/12,12px)] items-center relative size-full">
                  ...
                  <div className="content-stretch flex flex-col items-start pr-[3.33px] relative shrink-0" data-node-id="2:19660" data-name="span.font-sans">
                    <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[12.7px] text-[color:var(--color\/grey\/82,#cecfd2)] tracking-[var(--stroke-weight\/0_5,0.499px)] whitespace-nowrap" data-node-id="2:19661">
                      <p className="leading-[var(--font-size\/18,18px)] mb-0">Clain is the customer service platform built around an.</p>
      ...
      <frame id="2:20046" name="div.col-span-12:margin" x="537.3333740234375" y="0" width="472.125" height="219.22000122070312">
        <frame id="2:20048" name="div.col-span-12" x="52.125" y="0" width="420" height="219.22000122070312">
          <frame id="2:20050" name="p.font-sans" x="0" y="9.600000381469727" width="420" height="143.6300048828125">
            ...
            <text id="2:20054" name="architecture specifically engineered for complex customer service queries. Every layer is optimized for accuracy, speed, and reliability—so Fin can resolve more conversations, more effectively than competing AI Agents." x="0" y="22.80500030517578" width="414.8999938964844" height="120" />
          </frame>
