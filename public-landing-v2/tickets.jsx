...
(function () {
  ...
  const imgDivMinW0 = "/v2/assets/8ced544fff38058ebc560199acd402ab43b46cbf.png";
  const imgI2Y2ProductPageAssetTicketsFeatureHighlight01 = "/v2/assets/d9941f0fc3876f9cefe0d482d7ed90a974a77a02.png";
  const imgI2Y2ProductPageAssetTicketsColumnedMedia7 = "/v2/assets/ea16c384dc3f90551067b27d96742dd377091927.png";
  const imgI2Y2ProductPageAssetBackgroundsShoreline0845 = "/v2/assets/5089d61ebf6b5e82e983ef7bde0c8722b570e6a0.png";
    ...
    return (
      <PageShell>
        <div className="figma-page">
          <div className="content-stretch flex flex-col items-start pt-[48px] px-[16px] relative size-full" data-node-id="2:343" data-name="section.container">
      <div className="absolute inset-[16px]" data-node-id="2:345" data-name="div.pointer-events-none">
        <div className="absolute bg-[var(--color\/blue\/40,#0007cb)] left-0 size-[8px] top-0" data-node-id="2:346" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/blue\/40,#0007cb)] right-0 size-[8px] top-0" data-node-id="2:347" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/blue\/40,#0007cb)] bottom-0 left-0 size-[8px]" data-node-id="2:348" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/blue\/40,#0007cb)] bottom-0 right-0 size-[8px]" data-node-id="2:349" data-name="span.absolute" />
      </div>
      <div className="gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(12,minmax(0,1fr))] grid-rows-[__352.78px_812.44px] h-[1205.22px] pb-[24px] relative shrink-0 w-full" data-node-id="2:350" data-name="div.grid">
        <div className="col-[2/span_10] content-stretch flex flex-col items-start justify-center justify-self-stretch pl-[73.32px] pr-[73.35px] relative row-1 self-start shrink-0" data-node-id="2:351" data-name="div.flex">
          <div className="content-stretch flex flex-col items-start max-w-[1024px] relative shrink-0 w-full" data-node-id="2:352" data-name="div.mx-auto">
            <div className="content-stretch flex flex-col items-start pb-[16px] relative shrink-0 w-full" data-node-id="2:354" data-name="span.text-label-lg:margin">
              <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-node-id="2:355" data-name="span.text-label-lg">
                <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[color:var(--color\/grey\/7,#111)] text-[length:var(--font-size\/12,12px)] text-center tracking-[var(--letter-spacing\/0_6,0.6px)] uppercase whitespace-nowrap" data-node-id="2:356">
        ...
        <div className="bg-[var(--color\/grey\/93,#f1eee9)] col-[2/span_10] content-stretch flex flex-col items-start justify-self-stretch overflow-clip p-[48px] relative rounded-[12px] row-2 self-start shrink-0" data-node-id="2:378" data-name="div.bg-chalk">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img loading="lazy" decoding="async" alt="" className="absolute h-[115.27%] left-0 max-w-none top-[-7.64%] w-full" src={imgDivBgChalk} />
          </div>
          <div className="h-[716.44px] max-w-[1170.6700439453125px] relative shrink-0 w-[1074.67px]" data-node-id="2:382" data-name="tickets-foreground">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img loading="lazy" decoding="async" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgTicketsForeground} />
            </div>
          </div>
        </div>
      </div>
    </div>
        <div className="bg-[var(--color\/white\/solid,white)] content-stretch flex flex-col items-start pl-[134.66px] pr-[134.67px] py-[64px] relative size-full" data-node-id="2:385" data-name="section.container">
      <div className="content-stretch flex flex-col items-start justify-center relative shrink-0 w-full" data-node-id="2:386" data-name="div.col-span-full">
        <div className="content-stretch flex flex-col h-[388px] items-start justify-center relative shrink-0 w-full" data-node-id="2:387" data-name="div.col-span-full">
          ...
          <div className="content-stretch flex flex-col items-start py-[24px] relative shrink-0 w-full" data-node-id="2:391" data-name="div">
            <div className="gap-x-[32px] gap-y-[56px] grid grid-cols-[repeat(6,minmax(0,1fr))] grid-rows-[____32px_32px_32px_32px] h-[296px] px-[24px] relative shrink-0 w-full" data-node-id="2:392" data-name="div.mx-auto">
              <div className="col-1 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-1 shrink-0" data-node-id="2:393" data-name="Amazon logo">
                <Component className="h-[32.001px] overflow-clip relative shrink-0 w-[93.08px]" />
              </div>
              <div className="col-2 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-1 shrink-0" data-node-id="2:396" data-name="Amplitude logo">
                <Component className="h-[32.001px] overflow-clip relative shrink-0 w-[114.66px]" variant="2" />
              </div>
              <div className="col-3 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-1 shrink-0" data-node-id="2:399" data-name="Anthropic logo">
                <Component className="h-[31.999px] overflow-clip relative shrink-0 w-[122.84px]" variant="3" />
              </div>
              <div className="col-4 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-1 shrink-0" data-node-id="2:402" data-name="Autodesk logo">
                <Component className="h-[31.999px] overflow-clip relative shrink-0 w-[118.84px]" variant="4" />
              </div>
              <div className="col-5 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-1 shrink-0" data-node-id="2:405" data-name="A24 logo">
                <Component className="h-[32.002px] overflow-clip relative shrink-0 w-[54.66px]" variant="5" />
              </div>
              <div className="col-6 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-1 shrink-0" data-node-id="2:408" data-name="Clay logo">
                <Component className="h-[31.999px] overflow-clip relative shrink-0 w-[67.92px]" variant="6" />
              </div>
              <div className="col-1 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-2 shrink-0" data-node-id="2:414" data-name="Crypto.com logo">
                <Component className="h-[32.001px] overflow-clip relative shrink-0 w-[125.33px]" variant="7" />
              </div>
              <div className="col-2 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-2 shrink-0" data-node-id="2:420" data-name="Culture Amp logo">
                <Component className="h-[32px] overflow-clip relative shrink-0 w-[137.14px]" variant="8" />
              </div>
              <div className="col-3 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-2 shrink-0" data-node-id="2:423" data-name="DoorDash logo">
                <Component className="h-[32px] overflow-clip relative shrink-0 w-[129.14px]" variant="9" />
              </div>
              <div className="col-4 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-2 shrink-0" data-node-id="2:430" data-name="Etoro logo">
                <Component className="h-[32.002px] overflow-clip relative shrink-0 w-[78.66px]" variant="10" />
              </div>
              <div className="col-5 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-2 shrink-0" data-node-id="2:433" data-name="Gamma logo">
                <Component className="h-[32px] overflow-clip relative shrink-0 w-[82px]" variant="11" />
              </div>
              <div className="col-6 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-2 shrink-0" data-node-id="2:440" data-name="Jamf logo">
                <Component className="h-[31.999px] overflow-clip relative shrink-0 w-[71.31px]" variant="12" />
              </div>
              <div className="col-1 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-3 shrink-0" data-node-id="2:447" data-name="Lightspeed logo">
                <Component className="h-[31.999px] overflow-clip relative shrink-0 w-[117.7px]" variant="13" />
              </div>
              <div className="col-2 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-3 shrink-0" data-node-id="2:450" data-name="Linear logo">
                <Component className="h-[31.999px] overflow-clip relative shrink-0 w-[90.84px]" variant="14" />
              </div>
              <div className="col-3 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-3 shrink-0" data-node-id="2:453" data-name="Lovable logo">
                <Component className="h-[32px] overflow-clip relative shrink-0 w-[116px]" variant="15" />
              </div>
              <div className="col-4 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-3 shrink-0" data-node-id="2:456" data-name="Monday.com logo">
                <Component className="h-[31.999px] overflow-clip relative shrink-0 w-[126.84px]" variant="16" />
              </div>
              <div className="col-5 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-3 shrink-0" data-node-id="2:459" data-name="Nuuly logo">
                <Component className="h-[31.998px] overflow-clip relative shrink-0 w-[78.84px]" variant="17" />
              </div>
              <div className="col-6 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-3 shrink-0" data-node-id="2:462" data-name="Perplexity logo">
                <Component className="h-[32px] overflow-clip relative shrink-0 w-[112px]" variant="18" />
              </div>
              <div className="col-1 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-4 shrink-0" data-node-id="2:465" data-name="Prizepicks logo">
                <Component className="h-[32px] overflow-clip relative shrink-0 w-[140px]" variant="19" />
              </div>
              <div className="col-2 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-4 shrink-0" data-node-id="2:473" data-name="Rocket Money logo">
                <Component className="h-[31.999px] overflow-clip relative shrink-0 w-[91.31px]" variant="20" />
              </div>
              <div className="col-3 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-4 shrink-0" data-node-id="2:476" data-name="Shutterstock logo">
                <Component className="h-[32px] overflow-clip relative shrink-0 w-[124px]" variant="21" />
              </div>
              <div className="col-4 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-4 shrink-0" data-node-id="2:479" data-name="Toast logo">
                <Component className="h-[32px] overflow-clip relative shrink-0 w-[86.28px]" variant="22" />
              </div>
              <div className="col-5 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-4 shrink-0" data-node-id="2:482" data-name="Vanta logo">
                <Component className="h-[31.999px] overflow-clip relative shrink-0 w-[94.84px]" variant="23" />
              </div>
              <div className="col-6 content-stretch flex h-[32px] items-center justify-center justify-self-stretch relative row-4 shrink-0" data-node-id="2:485" data-name="WHOOP logo">
        ...
        <div className="bg-[var(--color\/grey\/97,#faf9f6)] content-stretch flex flex-col items-start pl-[134.66px] pr-[16px] py-[80px] relative size-full" data-node-id="2:488" data-name="section.container">
      <div className="content-stretch flex flex-col gap-[var(--item-spacing\/80,80px)] items-start justify-center relative shrink-0 w-full" data-node-id="2:491" data-name="div.col-span-full">
        <div className="content-stretch flex flex-col h-[162px] items-start relative shrink-0 w-[696px]" data-node-id="2:492" data-name="div.col-span-12">
          <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-node-id="2:493" data-name="h2.text-heading-3">
            <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[49.5px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-1_6,-1.6px)] w-full" data-node-id="2:494">
              <p className="leading-[var(--line-height\/54,54px)] mb-0">A better system for team</p>
              <p className="leading-[var(--line-height\/54,54px)] mb-0">collaboration and real-</p>
              <p className="leading-[var(--line-height\/54,54px)]">time customer updates</p>
            </div>
          </div>
        </div>
        <div className="gap-x-[16px] gap-y-[16px] grid grid-cols-[repeat(3,minmax(0,1fr))] grid-rows-[_359px] h-[359px] relative shrink-0 w-[1170.67px]" data-node-id="2:498" data-name="div.col-span-full">
          <div className="border-[length:var(--stroke-weight\/1,1px)] border-[var(--color\/orange\/80,#d3cec6)] border-solid col-1 content-stretch flex flex-col items-start justify-self-stretch min-h-[359px] p-[17px] relative row-1 self-stretch shrink-0" data-node-id="2:499" data-name="div.border-clay">
            <div className="relative shrink-0 w-full" data-node-id="2:503" data-name="h3.text-heading-5:margin">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[24px] relative size-full">
                <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-node-id="2:504" data-name="h3.text-heading-5">
                  <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[22.3px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-0_48,-0.48px)] w-full" data-node-id="2:505">
                    <p className="leading-[var(--line-height\/24,24px)]">Customer Tickets</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative shrink-0 w-full" data-node-id="2:508" data-name="p.text-body-lg:margin">
          ...
          <div className="border-[length:var(--stroke-weight\/1,1px)] border-[var(--color\/orange\/80,#d3cec6)] border-solid col-2 content-stretch flex flex-col items-start justify-self-stretch min-h-[359px] p-[17px] relative row-1 self-stretch shrink-0" data-node-id="2:512" data-name="div.border-clay">
            <div className="relative shrink-0 w-full" data-node-id="2:513" data-name="h3.text-heading-5:margin">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[24px] relative size-full">
                <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-node-id="2:514" data-name="h3.text-heading-5">
                  <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[21.9px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-0_48,-0.48px)] w-full" data-node-id="2:515">
                    <p className="leading-[var(--line-height\/24,24px)]">Back-office Tickets</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative shrink-0 w-full" data-node-id="2:517" data-name="p.text-body-lg:margin">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[7.195px] relative size-full">
          ...
          <div className="border-[length:var(--stroke-weight\/1,1px)] border-[var(--color\/orange\/80,#d3cec6)] border-solid col-3 content-stretch flex flex-col items-start justify-self-stretch min-h-[359px] p-[17px] relative row-1 self-stretch shrink-0" data-node-id="2:521" data-name="div.border-clay">
            <div className="relative shrink-0 w-full" data-node-id="2:522" data-name="h3.text-heading-5:margin">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[24px] relative size-full">
                <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-node-id="2:523" data-name="h3.text-heading-5">
                  <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[21.6px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-0_48,-0.48px)] w-full" data-node-id="2:524">
                    <p className="leading-[var(--line-height\/24,24px)]">Tracker Tickets</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative shrink-0 w-full" data-node-id="2:526" data-name="p.text-body-lg:margin">
              <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start pt-[7.195px] relative size-full">
      ...
      <div className="absolute inset-[16px]" data-node-id="2:529" data-name="div.text-clay">
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:530" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] right-0 size-[8px] top-0" data-node-id="2:531" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 left-0 size-[8px]" data-node-id="2:532" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 right-0 size-[8px]" data-node-id="2:533" data-name="span.absolute" />
      </div>
    </div>
        <div className="bg-[var(--color\/white\/solid,white)] content-stretch flex flex-col items-start pl-[134.66px] pr-[134.67px] py-[80px] relative size-full" data-node-id="2:534" data-name="section.container">
      <div className="content-stretch flex flex-col gap-[var(--item-spacing\/l,48px)] items-start justify-center relative shrink-0 w-full" data-node-id="2:535" data-name="div.col-span-full">
        <div className="content-stretch flex flex-col gap-[var(--line-height\/24,24px)] h-[151px] items-start pt-[7px] relative shrink-0 w-[696px]" data-node-id="2:537" data-name="div.col-span-12">
          <div className="content-stretch flex items-start justify-center relative shrink-0" data-node-id="2:538" data-name="span.text-label-lg">
            <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[11.3px] text-[color:var(--color\/grey\/7,#111)] text-center tracking-[var(--letter-spacing\/0_6,0.6px)] uppercase whitespace-nowrap" data-node-id="2:539">
              <p className="leading-[var(--font-size\/12,12px)]">Customer Tickets</p>
            </div>
          </div>
        ...
        <div className="content-stretch flex flex-col h-[877.5px] items-start relative shrink-0 w-full" data-node-id="2:544" data-name="div.col-span-full">
          <div className="content-stretch flex gap-[var(--item-spacing\/-0_01,0px)] items-start pr-[0.01px] relative shrink-0 w-full" data-node-id="2:545" data-name="div.relative">
            <div className="border-[length:var(--stroke-weight\/1,1px)] border-[var(--color\/orange\/85,#dedbd6)] border-solid content-stretch flex flex-col h-[877.5px] items-start justify-center mr-[-0.01px] overflow-clip p-px relative shrink-0 w-[702.41px]" data-node-id="2:547" data-name="div.min-w-0">
              ...
              <div className="flex-[1_0_0] min-h-px relative w-full" data-node-id="2:551" data-name="i2y2-product-page-asset-tickets-feature-highlight-01">
                <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none">
                  <img loading="lazy" decoding="async" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgI2Y2ProductPageAssetTicketsFeatureHighlight01} />
                </div>
              </div>
            </div>
            <div className="content-stretch flex flex-col items-start justify-center mr-[-0.01px] relative self-stretch shrink-0 w-[468.27px]" data-node-id="2:552" data-name="div.flex">
              <div className="bg-[var(--color\/black\/-3\%,rgba(0,0,0,0.03))] content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-[128px] overflow-clip relative w-full" data-node-id="2:553" data-name="button.group">
                <div className="content-stretch flex flex-[1_0_0] gap-[var(--line-height\/24,24px)] items-start min-h-px p-[24px] relative w-full" data-node-id="2:557" data-name="div.flex">
                  <div className="content-stretch flex flex-col h-[12px] items-start pt-[4px] relative shrink-0 w-[8px]" data-node-id="2:558" data-name="span.bg-helpdesk:margin">
                    <div className="bg-[var(--color\/blue\/40,#0007cb)] shrink-0 size-[8px]" data-node-id="2:559" data-name="span.bg-helpdesk" />
                  </div>
              ...
              <div className="content-stretch flex flex-[1_0_0] gap-[var(--line-height\/24,24px)] items-start min-h-px opacity-[var(--opacity\/60,0.6)] overflow-clip p-[24px] relative w-full" data-node-id="2:572" data-name="div.flex">
                <div className="content-stretch flex flex-col h-[12px] items-start pt-[4px] relative shrink-0 w-[8px]" data-node-id="2:574" data-name="span.bg-helpdesk:margin">
                  <div className="bg-[var(--color\/blue\/40,#0007cb)] shrink-0 size-[8px]" data-node-id="2:575" data-name="span.bg-helpdesk" />
                </div>
              ...
              <div className="content-stretch flex flex-[1_0_0] gap-[var(--line-height\/24,24px)] items-start min-h-px opacity-[var(--opacity\/60,0.6)] overflow-clip p-[24px] relative w-full" data-node-id="2:583" data-name="div.flex">
                <div className="content-stretch flex flex-col h-[12px] items-start pt-[4px] relative shrink-0 w-[8px]" data-node-id="2:584" data-name="span.bg-helpdesk:margin">
                  <div className="bg-[var(--color\/blue\/40,#0007cb)] shrink-0 size-[8px]" data-node-id="2:585" data-name="span.bg-helpdesk" />
                </div>
              ...
              <div className="content-stretch flex flex-[1_0_0] gap-[var(--line-height\/24,24px)] items-start min-h-px opacity-[var(--opacity\/60,0.6)] overflow-clip p-[24px] relative w-full" data-node-id="2:592" data-name="div.flex">
                <div className="content-stretch flex flex-col h-[12px] items-start pt-[4px] relative shrink-0 w-[8px]" data-node-id="2:593" data-name="span.bg-helpdesk:margin">
                  <div className="bg-[var(--color\/blue\/40,#0007cb)] shrink-0 size-[8px]" data-node-id="2:594" data-name="span.bg-helpdesk" />
                </div>
      ...
      <div className="absolute inset-[16px]" data-node-id="2:601" data-name="div.text-clay">
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:602" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] right-0 size-[8px] top-0" data-node-id="2:603" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 left-0 size-[8px]" data-node-id="2:604" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 right-0 size-[8px]" data-node-id="2:605" data-name="span.absolute" />
      </div>
    </div>
        <div className="bg-[var(--color\/grey\/97,#faf9f6)] content-stretch flex flex-col items-start pl-[134.66px] pr-[134.67px] py-[80px] relative size-full" data-node-id="2:606" data-name="section.container">
      <div className="content-stretch flex flex-col gap-[var(--item-spacing\/l,48px)] items-start justify-center relative shrink-0 w-full" data-node-id="2:607" data-name="div.col-span-full">
        <div className="content-stretch flex flex-col gap-[var(--line-height\/24,24px)] h-[97px] items-start pt-[7px] relative shrink-0 w-full" data-node-id="2:608" data-name="div.col-span-12">
          <div className="content-stretch flex items-start justify-center relative shrink-0" data-node-id="2:609" data-name="span.text-label-lg">
            <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[color:var(--color\/grey\/7,#111)] text-[length:var(--font-size\/12,12px)] text-center tracking-[var(--letter-spacing\/0_6,0.6px)] uppercase whitespace-nowrap" data-node-id="2:610">
              <p className="leading-[var(--font-size\/12,12px)]">Back-office Tickets</p>
            </div>
          </div>
        ...
        <div className="gap-x-[16px] gap-y-[24px] grid grid-cols-[repeat(12,minmax(0,1fr))] grid-rows-[_686.12px] h-[686.13px] relative shrink-0 w-full" data-node-id="2:614" data-name="div.col-span-full">
          <div className="col-[1/span_6] content-stretch flex flex-col items-start justify-self-stretch relative row-1 self-stretch shrink-0" data-node-id="2:615" data-name="div.col-span-full">
            <div className="content-stretch flex flex-col gap-[var(--item-spacing\/0,0px)] isolate items-start relative shrink-0 w-full" data-node-id="2:616" data-name="div.flex">
              <div className="content-stretch flex flex-col items-start pb-[24px] relative shrink-0 w-full z-[2]" data-node-id="2:618" data-name="div.bg-chalk:margin">
                <div className="aspect-[577.3300170898438/577.3300170898438] bg-[var(--color\/grey\/93,#f1eee9)] relative shrink-0 w-full" data-node-id="2:619" data-name="div.bg-chalk">
                  <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <img loading="lazy" decoding="async" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgDivBgChalk} />
                  </div>
                  <div className="absolute inset-[16px]" data-node-id="2:621" data-name="div.pointer-events-none">
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:622" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] right-[0.01px] size-[8px] top-0" data-node-id="2:623" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 left-0 size-[8px]" data-node-id="2:624" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 right-[0.01px] size-[8px]" data-node-id="2:625" data-name="span.absolute" />
                  </div>
                </div>
              </div>
          ...
          <div className="col-[7/span_6] content-stretch flex flex-col items-start justify-self-stretch relative row-1 self-stretch shrink-0" data-node-id="2:636" data-name="div.col-span-full">
            <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-node-id="2:637" data-name="div.flex">
              <div className="content-stretch flex flex-col items-start pb-[24px] relative shrink-0 w-full z-[2]" data-node-id="2:638" data-name="div.bg-chalk:margin">
                <div className="aspect-[577.3400268554688/577.3400268554688] bg-[var(--color\/grey\/93,#f1eee9)] relative shrink-0 w-full" data-node-id="2:639" data-name="div.bg-chalk">
                  <div className="absolute inset-[0_-0.01px_-0.01px_0]" data-node-id="2:640" data-name="i2y2-product-page-asset-tickets-columned-media-7">
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                      <img loading="lazy" decoding="async" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgI2Y2ProductPageAssetTicketsColumnedMedia7} />
                    </div>
                  </div>
                  <div className="absolute inset-[16px_15.99px_15.99px_16px]" data-node-id="2:641" data-name="div.pointer-events-none">
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:642" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] right-[-0.01px] size-[8px] top-0" data-node-id="2:643" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 left-0 size-[8px]" data-node-id="2:644" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 right-[-0.01px] size-[8px]" data-node-id="2:645" data-name="span.absolute" />
                  </div>
                </div>
              </div>
      ...
      <div className="absolute inset-[16px]" data-node-id="2:651" data-name="div.text-clay">
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:652" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] right-0 size-[8px] top-0" data-node-id="2:653" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-[0.01px] left-0 size-[8px]" data-node-id="2:654" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-[0.01px] right-0 size-[8px]" data-node-id="2:655" data-name="span.absolute" />
      </div>
    </div>
        <div className="bg-[var(--color\/white\/solid,white)] content-stretch flex flex-col items-start pl-[134.66px] pr-[134.67px] py-[80px] relative size-full" data-node-id="2:656" data-name="section.container">
      <div className="content-stretch flex flex-col gap-[var(--item-spacing\/l,48px)] items-start justify-center relative shrink-0 w-full" data-node-id="2:657" data-name="div.col-span-full">
        <div className="content-stretch flex flex-col gap-[var(--line-height\/24,24px)] h-[151px] items-start pt-[7px] relative shrink-0 w-[696px]" data-node-id="2:658" data-name="div.col-span-12">
          <div className="content-stretch flex items-start justify-center relative shrink-0" data-node-id="2:659" data-name="span.text-label-lg">
            <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[11.8px] text-[color:var(--color\/grey\/7,#111)] text-center tracking-[var(--letter-spacing\/0_6,0.6px)] uppercase whitespace-nowrap" data-node-id="2:660">
              <p className="leading-[var(--font-size\/12,12px)]">Tracker Tickets</p>
            </div>
          </div>
          <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-node-id="2:662" data-name="h2.text-heading-3">
            <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[50.3px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-1_6,-1.6px)] w-full" data-node-id="2:663">
              <p className="leading-[var(--line-height\/54,54px)] mb-0">Track multiple customers</p>
              <p className="leading-[var(--line-height\/54,54px)]">with one ticket</p>
            </div>
          </div>
        </div>
        <div className="content-stretch flex flex-col h-[877.5px] items-start relative shrink-0 w-full" data-node-id="2:665" data-name="div.col-span-full">
          <div className="content-stretch flex gap-[var(--item-spacing\/-0_01,0px)] h-[877.5px] isolate items-start pr-[0.01px] relative shrink-0 w-full" data-node-id="2:666" data-name="div.relative">
            <div className="content-stretch flex flex-col items-start justify-center mr-[-0.01px] relative self-stretch shrink-0 w-[468.27px] z-[2]" data-node-id="2:667" data-name="div.flex">
              <div className="bg-[var(--color\/black\/-3\%,rgba(0,0,0,0.03))] content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-h-px overflow-clip relative w-full" data-node-id="2:668" data-name="button.group">
                <div className="content-stretch flex flex-[1_0_0] gap-[var(--line-height\/24,24px)] items-start min-h-px p-[24px] relative w-full" data-node-id="2:669" data-name="div.flex">
                  <div className="content-stretch flex flex-col h-[12px] items-start pt-[4px] relative shrink-0 w-[8px]" data-node-id="2:670" data-name="span.bg-helpdesk:margin">
                    <div className="bg-[var(--color\/blue\/40,#0007cb)] shrink-0 size-[8px]" data-node-id="2:671" data-name="span.bg-helpdesk" />
                  </div>
                  <div className="content-stretch flex flex-col h-full items-start pb-[0.7px] relative shrink-0 w-[379px]" data-node-id="2:672" data-name="div.flex">
                    <div className="content-stretch flex items-start mb-[-0.7px] pb-[8px] relative shrink-0 w-full" data-node-id="2:673" data-name="h4.text-heading-6">
                      <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[18.4px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-0_2,-0.2px)] whitespace-nowrap" data-node-id="2:674">
                        <p className="leading-[var(--line-height\/19,19px)]">A single source of truth</p>
                      </div>
                    </div>
              ...
              <div className="content-stretch flex flex-[1_0_0] gap-[var(--line-height\/24,24px)] items-start min-h-px opacity-[var(--opacity\/60,0.6)] overflow-clip p-[24px] relative w-full" data-node-id="2:677" data-name="div.flex">
                <div className="content-stretch flex flex-col h-[12px] items-start pt-[4px] relative shrink-0 w-[8px]" data-node-id="2:678" data-name="span.bg-helpdesk:margin">
                  <div className="bg-[var(--color\/blue\/40,#0007cb)] shrink-0 size-[8px]" data-node-id="2:679" data-name="span.bg-helpdesk" />
                </div>
                <div className="content-stretch flex flex-col h-full items-start min-w-[388.2699890136719px] pb-[0.7px] relative shrink-0 w-[388.27px]" data-node-id="2:680" data-name="div.flex">
                  <div className="content-stretch flex items-start mb-[-0.7px] pb-[8px] relative shrink-0 w-full" data-node-id="2:681" data-name="h4.text-heading-6">
                    <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[18.6px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-0_2,-0.2px)] whitespace-nowrap" data-node-id="2:682">
                      <p className="leading-[var(--line-height\/19,19px)]">Easier customer updates</p>
                    </div>
                  </div>
              ...
              <div className="content-stretch flex flex-[1_0_0] gap-[var(--line-height\/24,24px)] items-start min-h-px opacity-[var(--opacity\/60,0.6)] overflow-clip p-[24px] relative w-full" data-node-id="2:685" data-name="div.flex">
                <div className="content-stretch flex flex-col h-[12px] items-start pt-[4px] relative shrink-0 w-[8px]" data-node-id="2:686" data-name="span.bg-helpdesk:margin">
                  <div className="bg-[var(--color\/blue\/40,#0007cb)] shrink-0 size-[8px]" data-node-id="2:687" data-name="span.bg-helpdesk" />
                </div>
            ...
            <div className="content-stretch flex flex-col items-start mr-[-0.01px] overflow-clip relative self-stretch shrink-0 w-[702.41px] z-[1]" data-node-id="2:694" data-name="div.overflow-hidden">
              <div className="content-stretch flex items-start relative shrink-0 w-[2804.22px]" data-node-id="2:695" data-name="div.flex">
                <div className="border-[length:var(--stroke-weight\/1,1px)] border-[var(--color\/orange\/85,#dedbd6)] border-solid content-stretch flex flex-[1_0_0] flex-col items-start justify-center min-w-px p-px relative self-stretch" data-node-id="2:696" data-name="div.min-w-0">
                  <div className="absolute inset-[0_-0.01px_0_0]" data-node-id="2:697" data-name="i2y2-product-page-asset-backgrounds-shoreline-08-4_5">
                    <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none">
                      <img loading="lazy" decoding="async" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgI2Y2ProductPageAssetBackgroundsShoreline0845} />
                    </div>
                  </div>
                  <div className="flex-[1_0_0] min-h-px relative w-full" data-node-id="2:698" data-name="i2y2-product-page-asset-tickets-feature-highlight-05">
                    <div className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 overflow-hidden pointer-events-none">
                      <img loading="lazy" decoding="async" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgI2Y2ProductPageAssetTicketsFeatureHighlight05} />
                    </div>
                  </div>
                </div>
                <div className="content-stretch flex flex-col h-[877.5px] items-start justify-center pl-[697px] relative shrink-0 w-[1399.41px]" data-node-id="2:699" data-name="div.min-w-0:css-transform">
                  <div className="border-[length:var(--stroke-weight\/1,1px)] border-[var(--color\/orange\/85,#dedbd6)] border-solid flex-[1_0_0] min-h-px opacity-0 w-full" data-node-id="2:700" data-name="div.min-w-0" />
                </div>
                <div className="content-stretch flex flex-col h-[877.5px] items-start justify-center relative shrink-0 w-[702.41px]" data-node-id="2:701" data-name="div.min-w-0:css-transform">
                  <div className="border-[length:var(--stroke-weight\/1,1px)] border-[var(--color\/orange\/85,#dedbd6)] border-solid flex-[1_0_0] min-h-px opacity-0 w-full" data-node-id="2:702" data-name="div.min-w-0" />
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="absolute inset-[16px]" data-node-id="2:703" data-name="div.text-clay">
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:704" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] right-0 size-[8px] top-0" data-node-id="2:705" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 left-0 size-[8px]" data-node-id="2:706" data-name="span.absolute" />
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 right-0 size-[8px]" data-node-id="2:707" data-name="span.absolute" />
      </div>
    </div>
        <div className="bg-[var(--color\/grey\/97,#faf9f6)] content-stretch flex flex-col items-start pl-[134.66px] pr-[134.67px] py-[80px] relative size-full" data-node-id="2:708" data-name="section.container">
      <div className="content-stretch flex flex-col gap-[var(--item-spacing\/l,48px)] items-start justify-center relative shrink-0 w-full" data-node-id="2:709" data-name="div.col-span-full">
        <div className="content-stretch flex flex-col gap-[var(--line-height\/24,24px)] h-[151px] items-start pt-[7px] relative shrink-0 w-full" data-node-id="2:710" data-name="div.col-span-12">
          <div className="content-stretch flex items-start justify-center relative shrink-0" data-node-id="2:711" data-name="span.text-label-lg">
            <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[11.8px] text-[color:var(--color\/grey\/7,#111)] text-center tracking-[var(--letter-spacing\/0_6,0.6px)] uppercase whitespace-nowrap" data-node-id="2:712">
        ...
        <div className="gap-x-[16px] gap-y-[24px] grid grid-cols-[repeat(12,minmax(0,1fr))] grid-rows-[_488.34px] h-[488.34px] relative shrink-0 w-full" data-node-id="2:715" data-name="div.col-span-full">
          <div className="col-[1/span_4] content-stretch flex flex-col items-start justify-self-stretch relative row-1 self-stretch shrink-0" data-node-id="2:716" data-name="div.col-span-full">
            <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-node-id="2:717" data-name="div.flex">
              <div className="content-stretch flex flex-col items-start pb-[24px] relative shrink-0 w-full z-[2]" data-node-id="2:718" data-name="div.bg-chalk:margin">
                <div className="aspect-[379.54998779296875/379.54998779296875] bg-[var(--color\/grey\/93,#f1eee9)] relative shrink-0 w-full" data-node-id="2:719" data-name="div.bg-chalk">
                  <div className="absolute inset-[0_0.01px_0.01px_0]" data-node-id="2:720" data-name="i2y2-product-page-asset-tickets-columned-media-8">
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                      <img loading="lazy" decoding="async" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgI2Y2ProductPageAssetTicketsColumnedMedia8} />
                    </div>
                  </div>
                  <div className="absolute inset-[16px_16.01px_16.01px_16px]" data-node-id="2:721" data-name="div.pointer-events-none">
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:722" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] right-[0.01px] size-[8px] top-0" data-node-id="2:723" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 left-0 size-[8px]" data-node-id="2:724" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 right-[0.01px] size-[8px]" data-node-id="2:725" data-name="span.absolute" />
                  </div>
                </div>
              </div>
              <div className="gap-x-[8px] gap-y-[8px] grid grid-cols-[_379.55px] grid-rows-[___24px_44.78px_0px] h-[84.78px] relative shrink-0 w-full z-[1]" data-node-id="2:726" data-name="div.grid">
                <div className="col-1 content-stretch flex flex-col items-start justify-self-stretch max-w-[512px] relative row-1 self-start shrink-0" data-node-id="2:727" data-name="h3.text-heading-5">
                  <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[22.3px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-0_48,-0.48px)] whitespace-nowrap" data-node-id="2:728">
                    <p className="leading-[var(--line-height\/24,24px)]">Side conversations</p>
                  </div>
                </div>
          ...
          <div className="col-[5/span_4] content-stretch flex flex-col items-start justify-self-stretch relative row-1 self-stretch shrink-0" data-node-id="2:731" data-name="div.col-span-full">
            <div className="content-stretch flex flex-col gap-[var(--item-spacing\/0_01,0.01px)] isolate items-start relative shrink-0 w-full" data-node-id="2:732" data-name="div.flex">
              <div className="content-stretch flex flex-col items-start pb-[24px] relative shrink-0 w-full z-[2]" data-node-id="2:734" data-name="div.bg-chalk:margin">
                <div className="aspect-[379.55999755859375/379.55999755859375] bg-[var(--color\/grey\/93,#f1eee9)] relative shrink-0 w-full" data-node-id="2:735" data-name="div.bg-chalk">
                  <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <img loading="lazy" decoding="async" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgDivBgChalk} />
                  </div>
                  <div className="absolute inset-[16px]" data-node-id="2:737" data-name="div.pointer-events-none">
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:738" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] right-[-0.01px] size-[8px] top-0" data-node-id="2:739" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-[-0.01px] left-0 size-[8px]" data-node-id="2:740" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-[-0.01px] right-[-0.01px] size-[8px]" data-node-id="2:741" data-name="span.absolute" />
                  </div>
                </div>
              </div>
              <div className="gap-x-[8px] gap-y-[8px] grid grid-cols-[_379.56px] grid-rows-[___24px_44.78px_0px] h-[84.78px] relative shrink-0 w-full z-[1]" data-node-id="2:742" data-name="div.grid">
                <div className="col-1 content-stretch flex flex-col items-start justify-self-stretch max-w-[512px] relative row-1 self-start shrink-0" data-node-id="2:743" data-name="h3.text-heading-5">
                  <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[22.7px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-0_48,-0.48px)] whitespace-nowrap" data-node-id="2:744">
                    <p className="leading-[var(--line-height\/24,24px)]">Company portal</p>
                  </div>
                </div>
          ...
          <div className="col-[9/span_4] content-stretch flex flex-col items-start justify-self-stretch relative row-1 self-stretch shrink-0" data-node-id="2:748" data-name="div.col-span-full">
            <div className="content-stretch flex flex-col isolate items-start relative shrink-0 w-full" data-node-id="2:749" data-name="div.flex">
              <div className="content-stretch flex flex-col items-start pb-[24px] relative shrink-0 w-full z-[2]" data-node-id="2:750" data-name="div.bg-chalk:margin">
                <div className="aspect-[379.54998779296875/379.54998779296875] bg-[var(--color\/grey\/93,#f1eee9)] relative shrink-0 w-full" data-node-id="2:751" data-name="div.bg-chalk">
                  <div className="absolute inset-[0_0.01px_0.01px_0]" data-node-id="2:752" data-name="i2y2-product-page-asset-tickets-columned-media-10">
                    <div className="absolute inset-0 overflow-hidden pointer-events-none">
                      <img loading="lazy" decoding="async" alt="" className="absolute left-0 max-w-none size-full top-0" src={imgI2Y2ProductPageAssetTicketsColumnedMedia10} />
                    </div>
                  </div>
                  <div className="absolute inset-[16px_16.01px_16.01px_16px]" data-node-id="2:753" data-name="div.pointer-events-none">
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:754" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] right-[0.01px] size-[8px] top-0" data-node-id="2:755" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 left-0 size-[8px]" data-node-id="2:756" data-name="span.absolute" />
                    <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] bottom-0 right-[0.01px] size-[8px]" data-node-id="2:757" data-name="span.absolute" />
                  </div>
                </div>
              </div>
              <div className="gap-x-[8px] gap-y-[8px] grid grid-cols-[_379.55px] grid-rows-[___24px_44.78px_0px] h-[84.78px] relative shrink-0 w-full z-[1]" data-node-id="2:758" data-name="div.grid">
                <div className="col-1 content-stretch flex flex-col items-start justify-self-stretch max-w-[512px] relative row-1 self-start shrink-0" data-node-id="2:759" data-name="h3.text-heading-5">
                  <div className="flex flex-col font-[family-name:var(--font-family\/font-1,'Inter:Regular',sans-serif)] font-[var(--font-weight\/400,400)] justify-center leading-[0] not-italic relative shrink-0 text-[22.3px] text-[color:var(--color\/grey\/7,#111)] tracking-[var(--letter-spacing\/-0_48,-0.48px)] whitespace-nowrap" data-node-id="2:760">
                    <p className="leading-[var(--line-height\/24,24px)]">Custom states</p>
                  </div>
                </div>
      ...
      <div className="absolute inset-[16px]" data-node-id="2:763" data-name="div.text-clay">
        <div className="absolute bg-[var(--color\/orange\/80,#d3cec6)] left-0 size-[8px] top-0" data-node-id="2:764" data-name="span.absolute" />
