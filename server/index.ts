...
import ticketStatesRouter from './routes/ticketStates.js';
import customObjectTypesRouter from './routes/customObjectTypes.js';
import customObjectFieldsRouter from './routes/customObjectFields.js';
import customObjectRecordsRouter from './routes/customObjectRecords.js';
...
app.use('/api/assignment-policies', assignmentPoliciesRouter);
...
app.use('/api/csat', csatSurveysRouter);
app.use('/api/reporting', reportingApiRouter);
...
app.use('/api/knowledge-embeddings', knowledgeEmbeddingsRouter);
app.use('/api/ai-feedback', aiFeedbackRouter);
app.use('/api/copilot-threads', copilotThreadsRouter);
...
app.use('/api/calls', callsApiRouter);
app.use('/api/tags', tagsRouter);
app.use('/api/labels', labelsRouter);
app.use('/api/topics', topicsRouter);
app.use('/api/webhook-subscriptions', webhookSubscriptionsRouter);
app.use('/api/ticket-types', ticketTypesRouter);
app.use('/api/ticket-states', ticketStatesRouter);
app.use('/api/custom-object-types', customObjectTypesRouter);
app.use('/api/custom-object-fields', customObjectFieldsRouter);
app.use('/api/custom-object-records', customObjectRecordsRouter);
