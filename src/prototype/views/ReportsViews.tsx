...
const METRIC_CATALOG: MetricDef[] = [
  ...
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo de respuesta de la llamada', desc: 'Duración desde que se inicia una llamada entrante hasta que un compañero de equipo la responde.', kind: 'time' },
];
