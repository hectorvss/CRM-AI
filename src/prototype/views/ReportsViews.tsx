...
const METRIC_CATALOG: MetricDef[] = [
  ...
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones en las que Fin AI Agent participó y que resolvió', desc: 'Número de conversaciones en las que Fin AI Agent respondió y el cliente dio una respuesta positiva o no solicitó hablar con un miembro del equipo. Datos disponibles a partir de octubre de 2025.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones en las que participó Fin for Ecommerce', desc: 'Número de conversaciones en las que Fin for Ecommerce intentó dar una respuesta. Datos disponibles a partir de octubre de 2025.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones en las que participó Fin for Ecommerce y que fueron resueltas', desc: 'Número de conversaciones en las que Fin for Ecommerce respondió y el cliente dio una respuesta positiva o no solicitó hablar con un miembro del equipo. Datos disponibles a partir de octubre de 2025.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones en las que participó Fin for Service', desc: 'Número de conversaciones en las que Fin for Service intentó dar una respuesta. Datos disponibles a partir de octubre de 2025.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones en las que participó Fin Sales', desc: 'Número de conversaciones que fueron transferidas a Fin Sales', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones en las que se creó un carrito en Fin for Ecommerce', desc: 'Número de conversaciones de Fin for Ecommerce donde se creó un carrito', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones en las que se debatió o recomendó un producto de Fin for Ecommerce', desc: 'Número de conversaciones en las que Fin for Ecommerce habló sobre un producto o lo recomendó', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones en las que se discutió el producto de Fin for Ecommerce', desc: 'Número de conversaciones en las que Fin for Ecommerce citó un producto en una respuesta de texto', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones en las que se hizo clic en la tarjeta de producto de Fin for Ecommerce', desc: 'Número de conversaciones de Fin for Ecommerce en las que se hizo clic en una tarjeta de producto', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones escaladas a soporte por Fin Sales', desc: 'Número de conversaciones del Fin Sales que se remitieron a asistencia', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones etiquetadas', desc: 'El número de conversaciones que se han etiquetado.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones no respondidas de Fin AI Agent', desc: 'Número de conversaciones en las que Fin AI Agent se involucró pero no dio una respuesta.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones pendientes de Fin AI Agent', desc: 'Número de conversaciones que aún no han sido resueltas, escaladas o transferidas conforme al procedimiento.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones reasignadas', desc: 'El número de conversaciones que se han asignado más de una vez después de la respuesta de un compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones respondidas primero a', desc: 'Número total de conversaciones con la respuesta inicial del compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones restringidas de Fin for Ecommerce', desc: 'Número de conversaciones en las que participó Fin for Ecommerce pero no intentó responder', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones restringidas de Fin for Service', desc: 'Número de conversaciones en las que participó Fin for Service pero no intentó dar una respuesta', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones restringidas por Fin AI Agent', desc: 'Número de conversaciones en las que Fin AI Agent estuvo involucrado pero no intentó dar una respuesta. Datos disponibles a partir de octubre de 2025.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones resueltas por Fin AI Agent', desc: 'Número de conversaciones en las que Fin AI Agent respondió y el cliente dio una respuesta positiva o no solicitó hablar con un compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones resueltas por Fin for Ecommerce', desc: 'Número de conversaciones resueltas por Fin en las que participó Fin for Ecommerce', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones resueltas por Fin for Service', desc: 'Número de conversaciones resueltas por Fin en las que participó Fin for Service', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones resueltas y en las que participó Fin for Service', desc: 'Número de conversaciones en las que Fin for Service respondió y el cliente dio una respuesta positiva o no solicitó hablar con un miembro del equipo. Datos disponibles a partir de octubre de 2025.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones sin interacción de Fin Sales', desc: 'Número de conversaciones con Fin Sales en las que el prospecto se desvinculó sin llegar a un resultado de enrutamiento', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Conversaciones sin resolver de Fin AI Agent', desc: 'Número de conversaciones en las que Fin AI Agent se involucró, pero el cliente dio comentarios negativos o pidió hablar con un compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Fin AI Agent desvió las conversaciones', desc: 'Número de conversaciones en las que Fin AI Agent participó, que aún no han llegado a un compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Fin AI Agent intensificó las conversaciones.', desc: 'Número de conversaciones en las que Fin AI Agent participó y el cliente pidió hablar con un compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Fin AI Agent respondió a las conversaciones', desc: 'Número de conversaciones en las que Fin AI Agent proporcionó al menos una respuesta.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Fin for Service tasa de resolución', desc: 'Porcentaje de conversaciones en las que participó Fin for Service en las que el cliente proporcionó un comentario positivo o no pidió hablar con un miembro del equipo. Datos disponibles a partir de octubre de 2025.', kind: 'rate' },
  ...
  { group: 'Conjunto de datos de conversación', title: 'Nuevas conversaciones', tag: 'Las conversaciones comenzaron el', desc: 'Número de conversaciones nuevas, por la fecha del primer mensaje del cliente.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Nuevas conversaciones', tag: 'Conversación creada en', desc: 'Número de conversaciones nuevas, por la fecha en la que se crearon.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Puntuación de la experiencia del cliente (CX)', tag: 'Cerrada por última vez a las', desc: 'El porcentaje de conversaciones que recibieron una calificación positiva de Puntuación CX (una puntuación de 4 o 5) de todas las conversaciones a las que se les asignó una Puntuación CX, para las conversaciones que se cerraron por última vez durante el intervalo de fechas seleccionado.', kind: 'ai' },
  { group: 'Conjunto de datos de conversación', title: 'Puntuación de la experiencia del cliente (CX)', tag: 'Las conversaciones comenzaron el', desc: 'El porcentaje de conversaciones que recibieron una calificación positiva de experiencia del cliente (CX) (una puntuación de 4 o 5) de todas las conversaciones a las que se les asignó una calificación de experiencia del cliente (CX), para las conversaciones a las que el usuario final respondió por primera vez durante el intervalo de fechas seleccionado.', kind: 'ai' },
  { group: 'Conjunto de datos de conversación', title: 'Reasignaciones por conversación', desc: 'Número de reasignaciones por conversación.', kind: 'score' },
  { group: 'Conjunto de datos de conversación', title: 'Resoluciones asumidas por Fin AI Agent', desc: 'Número de conversaciones en las que Fin AI Agent proporcionó una respuesta y el cliente salió sin pedir hablar con un compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Resoluciones con respuesta de IA', desc: 'Conversaciones en las que la última respuesta de Fin fue de IA y el cliente respondió con comentarios positivos o no pidió hablar con un compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Resoluciones con respuesta personalizadas', desc: 'Conversaciones en las que la última respuesta de Fin AI Agent fue una respuesta personalizada y el cliente respondió con comentarios positivos o no pidió hablar con un compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Resoluciones confirmadas de Fin AI Agent', desc: 'Número de conversaciones en las que Fin AI Agent proporcionó una respuesta y el cliente respondió con comentarios positivos.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Respuestas de compañeros de equipo por conversación', desc: 'Número de respuestas de compañeros de equipo por conversación.', kind: 'score' },
  { group: 'Conjunto de datos de conversación', title: 'Respuestas de usuario por conversación', desc: 'El número de respuestas de usuarios o prospectos en una conversación.', kind: 'score' },
  { group: 'Conjunto de datos de conversación', title: 'Respuestas para cerrar una conversación', desc: 'Número de respuestas de un compañero de equipo para cerrar una conversación.', kind: 'score' },
  { group: 'Conjunto de datos de conversación', title: 'Resultados de Fin AI Agent', desc: 'Número de conversaciones en las que Fin AI Agent obtuvo un resultado facturable —una resolución o una transferencia de procedimiento— de las conversaciones en las que Fin AI Agent intentó responder.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Resultados de Fin for Service', desc: 'Número de conversaciones en las que Fin for Service generó un resultado facturable —una resolución o una transferencia de procedimiento—, de las conversaciones en las que Fin for Service intentó responder.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Resultados de Fin para comercio electrónico', desc: 'Número de conversaciones en las que Fin for Ecommerce entregó un resultado facturable —una resolución o una transferencia de procedimiento— de las conversaciones en las que Fin for Ecommerce intentó responder.', kind: 'count' },
  { group: 'Conjunto de datos de conversación', title: 'Resultados de Fin Sales', desc: 'Número de conversaciones de Fin Sales que alcanzaron un resultado calificado o descalificado', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Reuniones de Fin Sales reservadas', desc: 'Número de conversaciones de Fin Sales en las que se reservó una reunión', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Reuniones de Fin Sales reservadas mediante el botón de Messenger', desc: 'Número de conversaciones de Fin Sales en las que la reunión se reservó desde el botón de Messenger para reservar reuniones (en lugar de hacerlo mediante el flujo de calificación)', kind: 'dataset' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de actividad de Fin AI Agent', desc: 'Porcentaje de conversaciones que se pasaron a Fin AI Agent (de las conversaciones nuevas en las que el cliente envió un mensaje).', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de actividad de Fin for Service', desc: 'Porcentaje de conversaciones en las que participó Fin for Service (de todas las conversaciones nuevas en las que el cliente envió un mensaje)', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de activo de Fin for Ecommerce', desc: 'Porcentaje de conversaciones en las que participó Fin for Ecommerce (de todas las conversaciones nuevas en las que el cliente envió un mensaje)', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de automatización de Fin for Ecommerce', desc: 'Porcentaje de conversaciones resueltas por Fin for Ecommerce (de las conversaciones nuevas en las que el cliente envió un mensaje)', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de automatización de Fin for Service', desc: 'Porcentaje de conversaciones resueltas por Fin for Service (de las conversaciones nuevas en las que el cliente envió un mensaje)', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de automatización del agente de inteligencia artificial de Fin', desc: 'Porcentaje de conversaciones que se resolvieron por Fin AI Agent (de las conversaciones nuevas en las que el cliente envió un mensaje)', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de captura de contactos de Fin Sales', desc: 'Porcentaje de conversaciones de ventas financieras donde se capturó una dirección de correo electrónico o un número de teléfono', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de clics en el proceso de pago de Fin for Ecommerce', desc: 'Porcentaje de conversaciones de Fin for Ecommerce en las que se hizo clic en un enlace de pago', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de clics en la tarjeta de producto de Fin for Ecommerce', desc: 'Porcentaje de conversaciones de Fin for Ecommerce en las que se hizo clic en una tarjeta de producto', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de conversaciones cerradas en el primer contacto', desc: 'Porcentaje de conversaciones que se cerraron una vez con respuestas de un solo compañero de equipo', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de creación de carrito de Fin for Ecommerce', desc: 'Porcentaje de conversaciones de Fin for Ecommerce en las que se creó un carrito', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de desvíos de Fin AI Agent', desc: 'Porcentaje de conversaciones en las que Fin AI Agent participó y que aún no han llegado a un compañero de equipo (de todas las conversaciones en las que participó Fin AI Agent).', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de escalación basada en la configuración del Fin AI Agent', desc: 'Porcentaje de conversaciones escaladas que se activaron por los ajustes de configuración (del total de conversaciones escaladas por el Fin AI Agent).', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de escalamiento de Fin AI Agent', desc: 'Porcentaje de conversaciones en las que el cliente pidió hablar con un compañero del equipo (de todas las conversaciones en las que participó Fin AI Agent).', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de finalización de Fin Sales', desc: 'Porcentaje de conversaciones de Fin Sales que han alcanzado un resultado de enrutamiento', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de participación de Fin AI Agent', desc: 'Porcentaje de conversaciones en las que Fin AI Agent intentó proporcionar una respuesta (de todas las conversaciones nuevas en las que el cliente envió un mensaje). Datos disponibles a partir de octubre de 2025.', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de participación de Fin for Ecommerce', desc: 'Porcentaje de conversaciones en las que Fin for Ecommerce intentó proporcionar una respuesta (de todas las conversaciones nuevas en las que el cliente envió un mensaje). Datos disponibles a partir de octubre de 2025.', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de participación de Fin for Service', desc: 'Porcentaje de conversaciones en las que Fin for Service intentó proporcionar una respuesta (de todas las conversaciones nuevas en las que el cliente envió un mensaje). Datos disponibles a partir de octubre de 2025.', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de participación de ventas de Fin', desc: 'Porcentaje de conversaciones que se transfirieron a Fin Sales (de todas las conversaciones nuevas en las que el cliente envió un mensaje)', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de pendientes de Fin AI Agent', desc: 'Porcentaje de conversaciones que aún no han sido resueltas, escaladas o transferidas conforme al procedimiento.', kind: 'rate' },
  { group: 'Conjunto de datos de conversación', title: 'Tasa de recontacto', beta: true, desc: 'Porcentaje de conversaciones en las que el mismo cliente se puso en contacto con asistencia dentro de las 24 horas posteriores a una resolución anterior.', kind: 'rate' },
  ...
  { group: 'Conjunto de datos de conversación', title: 'Tiempo hasta el primer cierre', tags: ['Tiempo de Inbox del bot excluido'], desc: 'Tiempo desde que comenzó la conversación hasta el momento en que un compañero de equipo la cerró por primera vez. Tiempo de Inbox del bot excluido.', kind: 'time' },
  { group: 'Conjunto de datos de conversación', title: 'Tiempo para cerrar', tags: ['Tiempo de Inbox del bot excluido'], desc: 'Tiempo desde que se inició la conversación hasta que se cerró.', kind: 'time' },
  { group: 'Conjunto de datos de conversación', title: 'Tiempo para cerrar', tags: ['Tiempo de Inbox del bot incluido'], desc: 'Tiempo desde que se inició la conversación hasta que se cerró.', kind: 'time' },
  { group: 'Conjunto de datos de conversación', title: 'Tiempo para la primera asignación', desc: 'La cantidad de tiempo que se tarda en asignar una conversación a un compañero de equipo.', kind: 'time' },
  { group: 'Conjunto de datos de conversación', title: 'Tiempo total en estado "Pospuesto" por conversación', desc: 'El tiempo total que una conversación ha permanecido en estado "Pospuesto", sumado en todos sus períodos de postergación. Promédielo para calcular el tiempo total típico que una conversación permanece en estado "Pospuesto", o súmelo para calcular el tiempo total en estado "Pospuesto" entre conversaciones.', kind: 'time' },
  { group: 'Conjunto de datos de conversación', title: 'Últimas conversaciones cerradas', desc: 'Número de conversaciones únicas cerradas más recientemente.', kind: 'count' },
  // Conjunto de datos de acciones de conversación
  { group: 'Conjunto de datos de acciones de conversación', title: 'Asignación de compañero de equipo a la respuesta inicial', desc: 'Tiempo que lleva enviar una respuesta inicial a un cliente después de que se asigna la conversación a un compañero de equipo', kind: 'time' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Asignación de compañero de equipo a una respuesta posterior', desc: 'Tiempo que lleva responder a los clientes por cada respuesta después de asignar una conversación a un compañero de equipo', kind: 'time' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Asignación de compañero de equipo para el cierre', desc: 'Tiempo que tarda un compañero de equipo en cerrar por primera vez después de asignarle una conversación', kind: 'time' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Asignación de equipo a la respuesta inicial', desc: 'Tiempo que lleva enviar una respuesta inicial a un cliente después de que se asigna una conversación a un equipo', kind: 'time' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Asignación de equipo a una respuesta posterior', desc: 'Tiempo que lleva responder a los clientes por cada respuesta posterior después de asignar una conversación a un equipo', kind: 'time' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Asignación de equipo al cierre', desc: 'Tiempo que lleva cerrar una conversación después de que se asigna a un equipo', kind: 'time' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones asignadas', desc: 'El número de conversaciones únicas asignadas.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones asignadas por hora activa', desc: 'Número de conversaciones asignadas a un compañero de equipo durante su estado activo', kind: 'score' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones cerradas', desc: 'Número de conversaciones únicas cerradas.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones cerradas por compañeros de equipo', desc: 'Número de conversaciones únicas cerradas por compañeros de equipo (excluye flujos de trabajo/automatización)', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones cerradas por hora activa', desc: 'Número de conversaciones cerradas por un compañero de equipo durante su estado activo', kind: 'score' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones con notas', desc: 'Número de conversaciones en las que un compañero de equipo dejó una nota interna.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones en las que participaron', desc: 'Número de conversaciones en las que un compañero de equipo participó.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones en las que participó por hora activa', desc: 'Número de conversaciones en las que participó un compañero de equipo durante su estado activo', kind: 'score' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones reabiertas', desc: 'El número de conversaciones que se volvieron a abrir.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones respondidas a', tags: ['Respuesta enviada el'], desc: 'Número de conversaciones que tienen respuestas de uno o más compañeros de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones respondidas a', tags: ['Las conversaciones comenzaron el'], desc: 'Número de conversaciones que tienen respuestas de uno o más compañeros de equipo. Solo se incluyen las conversaciones con al menos una respuesta del cliente.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Conversaciones respondidas por hora activa', desc: 'Número de conversaciones que tienen una o más respuestas del compañero de equipo durante su estado activo', kind: 'score' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Menciones', desc: 'Número de menciones en notas internas por parte de compañeros de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Notas creadas', desc: 'Número de notas redactadas.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Notas creadas por compañeros de equipo', desc: 'Número de notas redactadas por compañeros de equipo (excluye flujos de trabajo/automatización).', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Respuestas de compañeros de equipo enviadas por hora activa', desc: 'Cantidad de respuestas enviadas por los compañeros de equipo durante su estado activo', kind: 'score' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Respuestas enviadas', desc: 'Total de respuestas de compañeros de equipo enviadas, en conversaciones en las que participó un cliente.', kind: 'count' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Tiempo de respuesta', tags: ['Respuesta enviada el'], desc: 'Tiempo para responder a los clientes en cualquier momento durante una conversación.', kind: 'time' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Tiempo de respuesta', tags: ['Las conversaciones comenzaron el', 'Tiempo de Inbox del bot incluido'], desc: 'Tiempo para responder a los clientes en cualquier momento durante una conversación.', kind: 'time' },
  { group: 'Conjunto de datos de acciones de conversación', title: 'Tiempo de respuesta', tags: ['Las conversaciones comenzaron el', 'Tiempo de Inbox del bot excluido'], desc: 'Tiempo para responder a los clientes en cualquier momento durante una conversación.', kind: 'time' },
  // Conjunto de datos de calificación de conversaciones
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones de conversación de Fin AI Agent', desc: 'Número de calificaciones de conversaciones para Fin AI Agent', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones de conversación de chatbot', desc: 'Número de calificaciones de conversación para los chatbots.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones de las conversaciones de los compañeros de equipo', desc: 'Número de calificaciones de conversación de los compañeros de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones de las conversaciones de los compañeros de equipo', tags: ['Las conversaciones comenzaron el'], desc: 'Número de calificaciones de conversación de los compañeros de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones negativas de conversación de Fin AI Agent', desc: 'Número de calificaciones de conversación negativas (😠, 😦 o 😐) para Fin AI Agent.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones negativas de las conversaciones de los compañeros de equipo', desc: 'Número de calificaciones de conversación negativas (😠, 😦 o 😐) para compañeros de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones negativas de las conversaciones del chatbot', desc: 'Número de calificaciones de conversación negativas (😠, 😦 o 😐) para chatbots', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones positivas de conversación de Fin AI Agent', desc: 'Número de calificaciones de conversación positivas (🤩 o 😊) para Fin AI Agent.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones positivas de las conversaciones de los compañeros de equipo', desc: 'Número de calificaciones de conversación positivas (🤩 o 😊) para compañeros de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones positivas de las conversaciones de los chatbots', desc: 'Número de calificaciones de conversación positivas (🤩 o 😊) para chatbots.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Calificaciones positivas de las conversaciones de los compañeros de equipo', tags: ['Las conversaciones comenzaron el'], desc: 'Número de calificaciones de conversación positivas (🤩 o 😊) para compañeros de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Conversaciones con una respuesta de puntuación de conversación', desc: 'Número de conversaciones en las que se respondió al menos a una solicitud de calificación de conversación.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Conversaciones con una solicitud de calificación de conversación', desc: 'Número de conversaciones en las que se solicitó al menos una calificación de conversación.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuación CSAT', desc: 'Porcentaje de calificaciones de conversación positivas (🤩 o 😊) de todas las calificaciones de conversación para todos los agentes (compañeros de equipo, Fin AI Agent, chatbots).', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuación CSAT de Chatbot', desc: 'Porcentaje de calificaciones positivas (🤩 o 😊) de conversaciones para chatbots sobre el total de calificaciones de conversaciones para chatbots.', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuación CSAT de Fin AI Agent', desc: 'Porcentaje de calificaciones positivas (🤩 o 😊) de conversaciones para Fin AI Agent sobre el total de calificaciones de conversaciones para Fin AI Agent.', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuación CSAT del compañero de equipo', desc: 'Porcentaje de calificaciones de conversación positivas (🤩 o 😊) para compañeros de equipo de todas las calificaciones de conversación para compañeros de equipo.', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuación CSAT del compañero de equipo', tags: ['Las conversaciones comenzaron el'], desc: 'Porcentaje de calificaciones de conversación positivas (🤩 o 😊) para compañeros de equipo de todas las calificaciones de conversación para compañeros de equipo. (Conversación iniciada en)', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuación DSAT', desc: 'Porcentaje de calificaciones de conversación negativas (😠, 😦 o 😐) de todas las calificaciones de conversación para todos los agentes (compañeros de equipo, Fin AI Agent, chatbots).', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuación DSAT de chatbot', desc: 'Porcentaje de conversaciones negativas (😠, 😦 o 😐) para chatbots de todas las calificaciones de conversaciones para chatbots.', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuación DSAT de Fin AI Agent', desc: 'Porcentaje de calificaciones de conversación negativas (😠, 😦 o 😐) para Fin AI Agent de todas las calificaciones de conversaciones para Fin AI Agent.', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuación DSAT del compañero de equipo', desc: 'Porcentaje de calificaciones de conversación negativas (😠, 😦 o 😐) para compañeros de equipo de todas las calificaciones de conversaciones para compañeros de equipo.', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuaciones negativas de las conversaciones', desc: 'Número de calificaciones de conversación negativas (😠, 😦 o 😐) para todos los agentes (compañeros de equipo, Fin AI Agent, chatbots).', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Puntuaciones positivas de las conversaciones', desc: 'Número de calificaciones de conversación positivas (🤩 o 😊) para todos los agentes (compañeros de equipo, Fin AI Agent, chatbots).', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Se solicitaron las calificaciones de las conversaciones', desc: 'Número de todas las calificaciones de conversación solicitadas en todas las conversaciones.', kind: 'count' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Tasa de respuesta de CSAT', desc: 'Porcentaje de conversaciones en las que se respondió al menos a una solicitud de calificación de conversación de todas las conversaciones nuevas en las que el cliente envió un mensaje.', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'tasa de solicitudes de CSAT', desc: 'Porcentaje de conversaciones en las que se solicitó al menos una calificación de conversación de todas las conversaciones nuevas en las que el cliente envió un mensaje.', kind: 'rate' },
  { group: 'Conjunto de datos de calificación de conversaciones', title: 'Valoraciones de las conversaciones', desc: 'Número de calificaciones de conversación para todos los agentes (compañeros de equipo, Fin AI Agent y chatbots).', kind: 'count' },
  // Conjunto de datos del estado de la conversación
  { group: 'Conjunto de datos del estado de la conversación', title: 'Conversaciones abiertas', desc: 'El número de conversaciones con un estado "abierto" al final del período de tiempo.', kind: 'count' },
  { group: 'Conjunto de datos del estado de la conversación', title: 'Conversaciones pospuestas', desc: 'Número de conversaciones con un estado "pospuesto" al final del período de tiempo.', kind: 'count' },
  { group: 'Conjunto de datos del estado de la conversación', title: 'Tiempo en estado "Pospuesto"', desc: 'Tiempo que las conversaciones han pasado en el estado "Pospuesto", medido por cada posposición. Promédielo para obtener la duración típica de una posposición, o súmelo para obtener el tiempo total en estado "Pospuesto".', kind: 'time' },
  // Conjunto de datos de folios de atención
  { group: 'Conjunto de datos de folios de atención', title: 'Folios de atención resueltos', desc: 'Número de folios de atención resueltos.', kind: 'count' },
  { group: 'Conjunto de datos de folios de atención', title: 'Nuevos folios de atención', desc: 'Número de folios de atención nuevos creados para folios que se enviaron durante el intervalo de fechas seleccionado.', kind: 'count' },
  { group: 'Conjunto de datos de folios de atención', title: 'Tiempo para resolver el folio de atención', desc: 'Hora desde la fecha en que se envió el folio de atención hasta que se resolvió.', kind: 'time' },
  { group: 'Conjunto de datos de folios de atención', title: 'Tiempo para resolver el folio de atención (horario de oficina del equipo)', desc: 'Hora desde la fecha en que se envió el folio de atención hasta que se resolvió.', kind: 'time' },
  // Tiempo de folio de atención en el conjunto de datos de estado
  { group: 'Tiempo de folio de atención en el conjunto de datos de estado', title: 'Tiempo del folio de atención pasado en enviado', desc: 'Tiempo que los folios de atención han permanecido en la categoría de estado enviado.', kind: 'count' },
  { group: 'Tiempo de folio de atención en el conjunto de datos de estado', title: 'Tiempo del folio de atención pasado en esperando al cliente', desc: 'Tiempo que los folios de atención han pasado en espera en la categoría de estado del cliente.', kind: 'count' },
  { group: 'Tiempo de folio de atención en el conjunto de datos de estado', title: 'Tiempo del folio de atención pasado en progreso', desc: 'Tiempo que los folios de atención han pasado en la categoría de estado en curso.', kind: 'count' },
  { group: 'Tiempo de folio de atención en el conjunto de datos de estado', title: 'Tiempo que el folio de atención pasó en todos los estados', desc: 'Tiempo que los folios de atención han pasado en todos los estados.', kind: 'count' },
  // Conjunto de datos de gestión de compañero de equipo
  { group: 'Conjunto de datos de gestión de compañero de equipo', title: 'Tiempo de gestión del compañero de equipo', desc: 'Tiempo empleado por un compañero de equipo al trabajar en una conversación.', kind: 'time' },
  { group: 'Conjunto de datos de gestión de compañero de equipo', title: 'Tiempo de manejo ajustado del miembro del equipo', desc: 'Tiempo empleado por un compañero del equipo en trabajar en una conversación, se excluyen los períodos de inactividad cuando los compañeros de equipo no estaban trabajando activamente.', kind: 'time' },
  // Conjunto de datos de cambio de estado de compañero de equipo
  { group: 'Conjunto de datos de cambio de estado de compañero de equipo', title: 'Tiempo "activo" de un compañero de equipo', desc: 'Tiempo que pasa un compañero de equipo en estado "activo".', kind: 'time' },
  { group: 'Conjunto de datos de cambio de estado de compañero de equipo', title: 'Tiempo "ausente y reasignar" de un compañero de equipo', desc: 'Tiempo que un compañero de equipo pasa en un estado de "ausente y reasignando"', kind: 'time' },
  { group: 'Conjunto de datos de cambio de estado de compañero de equipo', title: 'Tiempo de ausencia del compañero de equipo', desc: 'Tiempo que pasa un compañero de equipo en estado "ausente"', kind: 'time' },
  // Conjunto de datos de SLA
  { group: 'Conjunto de datos de SLA', title: 'Conversaciones y folios con SLA', desc: 'Número de conversaciones y folios de atención que tuvieron al menos un Acuerdo de Nivel de Servicio.', kind: 'count' },
  { group: 'Conjunto de datos de SLA', title: 'Conversaciones y folios de atención con SLA no cumplido', desc: 'Número de conversaciones y folios de atención en los que se infringió un Acuerdo de Nivel de Servicio.', kind: 'count' },
  { group: 'Conjunto de datos de SLA', title: 'Hit de SLA', desc: 'La cantidad de SLA aplicados a las conversaciones que llegaron a su segmento.', kind: 'count' },
  { group: 'Conjunto de datos de SLA', title: 'SLA aplicados', desc: 'La cantidad de SLA aplicados a las conversaciones.', kind: 'count' },
  { group: 'Conjunto de datos de SLA', title: 'SLA incumplidos', tags: ['SLA iniciado a las'], desc: 'El número de SLA aplicados a las conversaciones que no alcanzaron su objetivo.', kind: 'count' },
  { group: 'Conjunto de datos de SLA', title: 'SLA incumplidos', tags: ['SLA incumplido en'], desc: 'El número de SLA aplicados a las conversaciones que no alcanzaron su objetivo.', kind: 'count' },
  { group: 'Conjunto de datos de SLA', title: 'Tasa de cumplimiento del Acuerdo de Nivel de Servicio', desc: 'El % del Acuerdo de Nivel de Servicio aplicado a las conversaciones que llegaron a su segmento, de todos los Acuerdos de Nivel de Servicio aplicados a las conversaciones.', kind: 'rate' },
  { group: 'Conjunto de datos de SLA', title: 'Tasa de incumplimiento del SLA de conversaciones y folios de atención', desc: 'Porcentaje de conversaciones y folios de atención en los que se infringió un Acuerdo de Nivel de Servicio. (Anteriormente "SLA miss rate")', kind: 'rate' },
  { group: 'Conjunto de datos de SLA', title: 'Tasa de SLA faltantes', desc: 'El % del Acuerdo de Nivel de Servicio aplicado a las conversaciones que no llegaron a su segmento, de todos los Acuerdos de Nivel de Servicio aplicados a las conversaciones.', kind: 'rate' },
  { group: 'Conjunto de datos de SLA', title: 'Tiempo de respuesta después de un incumplimiento del SLA', desc: 'Tiempo transcurrido desde que se perdió el SLA hasta que se recibió una respuesta de un compañero de equipo.', kind: 'time' },
  // Conjunto de datos de Copilot
  { group: 'Conjunto de datos de Copilot', title: 'Compañeros de equipo que usan Copilot', desc: 'Número de compañeros de equipo que han usado Copilot al menos una vez.', kind: 'count' },
  { group: 'Conjunto de datos de Copilot', title: 'Conversaciones con Copilot', desc: 'Número de conversaciones en las que se utilizó Copilot al menos una vez. Solo se incluyen las conversaciones con al menos una respuesta de un compañero de equipo y una respuesta del cliente.', kind: 'count' },
  { group: 'Conjunto de datos de Copilot', title: 'Conversaciones con una respuesta de Copilot copiada', desc: 'Número de conversaciones en las que Copilot proporcionó una respuesta que se copió o agregó al procesador de texto. Solo se incluyen las conversaciones con al menos una respuesta de un compañero de equipo y una respuesta del cliente.', kind: 'count' },
  { group: 'Conjunto de datos de Copilot', title: 'Conversaciones respondidas con al menos una respuesta de Copilot', desc: 'Número de conversaciones en las que Copilot proporcionó una respuesta correcta. Solo se incluyen las conversaciones con al menos una respuesta de un compañero de equipo y una respuesta del cliente.', kind: 'count' },
  { group: 'Conjunto de datos de Copilot', title: 'Preguntas sobre Copilot', desc: 'Número de preguntas hechas a Copilot.', kind: 'count' },
  { group: 'Conjunto de datos de Copilot', title: 'Tasa de respuestas copiadas de Copilot', desc: 'Porcentaje de conversaciones en las que Copilot proporcionó una respuesta que se copió o agregó al procesador de texto. Solo se incluyen las conversaciones con al menos una respuesta de un compañero de equipo y una respuesta del cliente.', kind: 'rate' },
  { group: 'Conjunto de datos de Copilot', title: 'Tasa de uso de conversaciones de Copilot', desc: 'Porcentaje de conversaciones en las que se utilizó Copilot al menos una vez. Solo se incluyen las conversaciones con al menos una respuesta de un compañero de equipo y una respuesta del cliente.', kind: 'rate' },
  // Conjunto de datos de llamadas
  { group: 'Conjunto de datos de llamadas', title: 'Answered calls', desc: 'Total number of calls, across all directions, that were answered by a teammate. This includes calls where the end user was placed on hold and abandoned the call while on hold, since the caller was already connected to a teammate.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Duración de la llamada', desc: 'Duración total de una llamada para un usuario final desde que se realiza la llamada hasta que finaliza. Esto incluye todas las llamadas: las contestadas, las abandonadas y el buzón de voz. Cuando se agrupa (por ejemplo: usando la mediana), esto puede diferir del tiempo de conversación de la llamada, que solo incluye las llamadas contestadas.', kind: 'time' },
  { group: 'Conjunto de datos de llamadas', title: 'Llamadas de correo de voz', desc: 'Cantidad total de llamadas con un correo de voz.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Llamadas entrantes', desc: 'Número total de llamadas asignadas al compañero de equipo.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Llamadas entrantes abandonadas', desc: 'La cantidad total de llamadas entrantes que se perdieron porque el usuario final abandonó la llamada durante la canalización, la fila, en espera o en el correo de voz.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Llamadas entrantes completadas', desc: 'La cantidad total de llamadas entrantes respondidas por un compañero de equipo y completadas correctamente.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Llamadas fuera de la oficina', desc: 'Cantidad total de llamadas entrantes que se realizaron fuera del horario de atención.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Llamadas nuevas', desc: 'Cantidad total de llamadas. Esto incluye llamadas entrantes, llamadas salientes y llamadas de Messenger. Puede haber varias llamadas por conversación.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Llamadas salientes', desc: 'La cantidad total de llamadas telefónicas salientes.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Missed calls', desc: 'Total number of inbound calls not answered by a teammate — the caller abandoned before connecting, or left a voicemail. Breaks down into abandoned and voicemail calls.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Parte que finaliza la llamada', desc: 'Desglose de las llamadas según la parte que finalizó la llamada.', kind: 'count' },
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo de canales salientes', desc: 'Duración desde que se inicia una llamada saliente hasta que el usuario final responde a la llamada.', kind: 'time' },
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo de conversación de la llamada', desc: 'El tiempo que el usuario final pasa hablando con un compañero de equipo durante una llamada. Si se transfiere la llamada, este es el tiempo total de la conversación en todas las transferencias. El tiempo de conversación de la llamada excluye el tiempo que el miembro del equipo puso la llamada en espera.', kind: 'time' },
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo de espera de la llamada', desc: 'Duración que el usuario final pasa en espera durante una llamada. Si una llamada tiene varios periodos de espera, este es el tiempo total de espera entre todas las esperas.', kind: 'time' },
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo de espera en canales entrantes.', desc: 'Duración que el usuario final pasa en espera durante una llamada entrante. Si una llamada tiene varios periodos de espera, este es el tiempo total de espera entre todas las esperas.', kind: 'time' },
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo de gestión de llamadas', beta: true, desc: 'Tiempo total de gestión de una llamada, incluido el tiempo de conversación, el tiempo en espera y el tiempo de resumen. Esta es la métrica estándar de la industria de tiempo de gestión promedio (AHT).', kind: 'time' },
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo de respuesta de la llamada', desc: 'La duración desde el momento en que el usuario final hace la llamada hasta el momento en que un compañero del equipo la responde por primera vez.', kind: 'time' },
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo de resumen de la llamada', beta: true, desc: 'Duración que los miembros del equipo pasan en cierre (trabajo posterior a la llamada) después de que finaliza una llamada. Si se transfiere una llamada, este es el tiempo total de cierre en todos los agentes.', kind: 'time' },
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo en fila de la llamada', desc: 'El tiempo que el usuario final espera en la fila para conectarse con un compañero de equipo después de que la llamada se haya asignado a un equipo. Si luego se transfiere una llamada a diferentes equipos, esto incluye el tiempo total de espera en la fila en todas las transferencias.', kind: 'time' },
  { group: 'Conjunto de datos de llamadas', title: 'Tiempo total de ocupación de la llamada', beta: true, desc: 'Tiempo total en que un miembro del equipo está ocupado por una llamada, incluido el tiempo de marcación y el tiempo de gestión (conversación, espera y cierre).', kind: 'time' },
  // Conjunto de datos de estadísticas de llamadas de equipo
  { group: 'Conjunto de datos de estadísticas de llamadas de equipo', title: 'El equipo rechazó el recuento de llamadas', desc: 'Número total de llamadas rechazadas por los miembros del equipo mientras estaban asignados al personal.', kind: 'count' },
  { group: 'Conjunto de datos de estadísticas de llamadas de equipo', title: 'Llamada de equipo en tiempo en fila', desc: 'El tiempo que el usuario espera en la fila para conectarse con un compañero de equipo después de que la llamada se haya asignado a un equipo.', kind: 'time' },
  { group: 'Conjunto de datos de estadísticas de llamadas de equipo', title: 'Recuento de llamadas perdidas del equipo', desc: 'Número total de llamadas perdidas por los miembros del equipo mientras están asignados a un equipo.', kind: 'count' },
  { group: 'Conjunto de datos de estadísticas de llamadas de equipo', title: 'Tiempo de conversación de llamada por equipo', desc: 'Tiempo que todos los compañeros de equipo pasaron hablando durante una llamada, mientras estaban asignados a un equipo.', kind: 'time' },
  { group: 'Conjunto de datos de estadísticas de llamadas de equipo', title: 'Tiempo de espera en llamadas por equipo.', desc: 'Tiempo que los clientes pasaron en espera durante una llamada, mientras estaban asignados a un equipo.', kind: 'time' },
  { group: 'Conjunto de datos de estadísticas de llamadas de equipo', title: 'Tiempo de gestión de llamada por equipo', beta: true, desc: 'Tiempo total de gestión de una llamada mientras está asignada a un equipo, incluido el tiempo de conversación, el tiempo en espera y el tiempo de resumen de la llamada.', kind: 'time' },
  { group: 'Conjunto de datos de estadísticas de llamadas de equipo', title: 'Tiempo de resumen de la llamada del equipo', beta: true, desc: 'Tiempo que los compañeros de equipo pasan en la fase de cierre después de que finaliza una llamada, mientras están asignados a un equipo.', kind: 'time' },
  // Conjunto de datos de estadísticas de llamadas de compañeros de equipo
  { group: 'Conjunto de datos de estadísticas de llamadas de compañeros de equipo', title: 'Conteo de llamadas perdidas de compañeros de equipo', desc: 'Número total de llamadas perdidas por un miembro del equipo.', kind: 'count' },
  { group: 'Conjunto de datos de estadísticas de llamadas de compañeros de equipo', title: 'El compañero del equipo rechazó el recuento de llamadas', desc: 'Número total de llamadas rechazadas por un compañero del equipo.', kind: 'count' },
  { group: 'Conjunto de datos de estadísticas de llamadas de compañeros de equipo', title: 'Tiempo de conversación de llamada por compañero de equipo', desc: 'Tiempo que un compañero de equipo pasa hablando durante una llamada. Excluye el tiempo que el compañero de equipo puso la llamada en espera.', kind: 'time' },
  { group: 'Conjunto de datos de estadísticas de llamadas de compañeros de equipo', title: 'Tiempo de gestión de llamada del miembro del equipo', beta: true, desc: 'El tiempo total de gestión de un miembro del equipo en una llamada, incluido el tiempo de conversación, el tiempo en espera y el tiempo de cierre.', kind: 'time' },
  { group: 'Conjunto de datos de estadísticas de llamadas de compañeros de equipo', title: 'Tiempo de llamadas salientes del compañero de equipo', desc: 'Tiempo que pasan los compañeros de equipo realizando llamadas salientes antes de que el usuario final responda.', kind: 'time' },
  { group: 'Conjunto de datos de estadísticas de llamadas de compañeros de equipo', title: 'Tiempo de resumen de llamada del compañero de equipo', beta: true, desc: 'Duración que un compañero de equipo pasa en post-llamada después de que finaliza una llamada.', kind: 'time' },
  { group: 'Conjunto de datos de estadísticas de llamadas de compañeros de equipo', title: 'Tiempo en espera de llamada por compañero de equipo', desc: 'Duración que los clientes pasaron en espera durante las llamadas con un compañero del equipo.', kind: 'time' },
  { group: 'Conjunto de datos de estadísticas de llamadas de compañeros de equipo', title: 'Tiempo total de ocupación del miembro del equipo', beta: true, desc: 'El tiempo total que un compañero de equipo está ocupado por una llamada, incluido el tiempo de marcación, el tiempo de gestión (conversación, espera y cierre) y cualquier tiempo adicional.', kind: 'time' },
];
