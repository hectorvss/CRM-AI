...
const METRIC_CATALOG: MetricDef[] = [
  ...
  { group: 'Conjunto de datos de cambio de estado de compañero de equipo', title: 'Tiempo "ausente y reasignar" de un compañero de equipo', desc: 'Tiempo que pasa un compañero de equipo en estado "ausente y reasignar".', kind: 'time' },
];
