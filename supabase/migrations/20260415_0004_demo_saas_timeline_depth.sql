...
values
  ('ar_001', 'case_001', 'org_default', 'ws_default', 'agent_composer', 'agent_composer_v1', 'case_created', 'case_event', 'completed', 'completed', 0.98, 'Composer confirmed bank clearance and drafted the follow-up reply', jsonb_build_object('summary', 'Reply prepared for Sarah'), jsonb_build_array('ce_001', 'ce_004'), 'proceed', 1820, 0.42, null, null, timestamp '2026-04-15 11:58:00+00', timestamp '2026-04-15 12:00:00+00', timestamp '2026-04-15 12:00:00+00'),
  ('ar_002', 'case_001', 'org_default', 'ws_default', 'agent_stripe', 'agent_stripe_v1', 'approval_requested', 'approval_event', 'running', 'running', 0.92, 'Stripe connector waiting on PSP and OMS alignment', jsonb_build_object('summary', 'Clearance check in progress'), jsonb_build_array('ce_002'), 'hold', 1450, 0.31, null, null, timestamp '2026-04-15 12:05:00+00', null, null),
  ('ar_003', 'case_002', 'org_default', 'ws_default', 'agent_shopify', 'agent_shopify_v1', 'case_created', 'case_event', 'completed', 'completed', 0.95, 'Shopify connector ingested the cancellation notice', jsonb_build_object('summary', 'Cancellation sync complete'), jsonb_build_array('ce_005', 'ce_006'), 'proceed', 980, 0.18, null, null, timestamp '2026-04-15 10:58:00+00', timestamp '2026-04-15 11:02:00+00', timestamp '2026-04-15 11:02:00+00'),
  ('ar_004', 'case_003', 'org_default', 'ws_default', 'agent_canonicalizer', 'agent_canonicalizer_v1', 'manual_review', 'case_event', 'blocked', 'blocked', 0.89, 'Canonicalizer detected payment and return mismatch', jsonb_build_object('summary', 'State mismatch surfaced to risk'), jsonb_build_array('ce_008', 'ce_009'), 'pause', 1320, 0.27, 'state mismatch', 'Stripe and OMS disagree on refund state', timestamp '2026-04-15 10:40:00+00', timestamp '2026-04-15 10:41:00+00', timestamp '2026-04-15 10:41:00+00'),
  ('ar_005', 'case_004', 'org_default', 'ws_default', 'agent_returns', 'agent_returns_v1', 'case_created', 'case_event', 'running', 'running', 0.94, 'Returns agent is waiting for warehouse confirmation', jsonb_build_object('summary', 'Replacement approval pending'), jsonb_build_array('ce_011', 'ce_012'), 'proceed', 1110, 0.22, null, null, timestamp '2026-04-15 12:15:00+00', null, null),
  ('ar_006', 'case_004', 'org_default', 'ws_default', 'agent_composer', 'agent_composer_v1', 'reply_requested', 'case_event', 'completed', 'completed', 0.97, 'Composer drafted the reply for replacement approval', jsonb_build_object('summary', 'Customer update ready'), jsonb_build_array('ce_012'), 'proceed', 940, 0.20, null, null, timestamp '2026-04-15 12:18:00+00', timestamp '2026-04-15 12:19:00+00', timestamp '2026-04-15 12:19:00+00')
on conflict (id) do update set
  case_id = excluded.case_id,
  tenant_id = excluded.tenant_id,
  workspace_id = excluded.workspace_id,
